    ...
    <h1 class="mr-2"  >BARANGAY-<span style="color: #603ce6;"> 409</span> </h1>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mx-auto">
          ...
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="#news"  onclick="shownews()">Announcement</a>
          </li> 
        </ul>
...
<div  id="Displayenews" style="display:block;" class="card shadow border-0 mb-7">
