...
<p style="text-align: justify;">Barangay 409 is a barangay in the city of Manila, under the administrative district 
  ...
  <div style="text-align: center;">
    ...
    <a href="https://www.philatlas.com/luzon/ncr/manila/barangay-409.html" target="_blank" class="read-more" style="background-color: transparent; border: 1px solid #603ce6; color: #603ce6;">Services</a>
  </div>
</div>
</section>
</div>
  ...
  <div class="contact-container bg-white custom-shadow mt-n6">
    <div class="form-container">
      ...
      <form action="Home.php" class="contact-form">
        ...
        <input style="color: #fff;" type="submit" value="Send" class="send-button" id="messagebrgy">
      </form>
    </div>
    <!-- maps-->
    <div class="map">
