...
echo '<div id="homenews" class="modal-dialog modal-lg" role="document">'; // Using modal-lg for larger screens
...
echo '</button>';
echo '</div>';
echo '<div class="modal-body d-flex flex-column">'; // Using flex-column to stack items vertically on small screens
// Add styling to the modal image on the right
echo '<div class="modal-image-container">';
echo '<img src="Loginsystem/uploads/' . $image . '" class="card-img-top" alt="Card Image" style="width: 100%; height: auto; object-fit: cover;">'; // Adjusting height to auto for responsiveness
echo '</div>';
