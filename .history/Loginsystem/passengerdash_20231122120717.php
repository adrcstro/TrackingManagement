...
<div class="modal fade" id="Drivertrack">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div id="Rate" style="width: 80%; margin: auto;  margin-bottom: 20px;">
    ...
    <!-- Buttons for rating -->
    <button type="button" class="btn btn-outline-secondary btn-sm m-1 custom-btn" data-toggle="modal" data-target="#rate1Star" onclick="updateRating(1)">
    <i class="bi bi-star"></i> 1 Star
</button>

<button type="button" class="btn btn-outline-secondary btn-sm m-1 custom-btn" data-toggle="modal" data-target="#rate2Stars" onclick="updateRating(2)">
    <i class="bi bi-star"></i> 2 Stars
</button>

<button type="button" class="btn btn-outline-secondary btn-sm m-1 custom-btn" data-toggle="modal" data-target="#rate3Stars" onclick="updateRating(3)">
    <i class="bi bi-star"></i> 3 Stars
</button>

<button type="button" class="btn btn-outline-secondary btn-sm m-1 custom-btn" data-toggle="modal" data-target="#rate4Stars" onclick="updateRating(4)">
    <i class="bi bi-star"></i> 4 Stars
</button>

<button type="button" class="btn btn-outline-secondary btn-sm m-1 custom-btn" data-toggle="modal" data-target="#rate5Stars" onclick="updateRating(5)">
...
<script>
    function updateRating(rating) {
        document.getElementById("RateTextArea").value = rating + " Stars";
