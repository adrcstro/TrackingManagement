function showDriver() {
    ...
    document.getElementById('drivercomplainaboutyou').style.display = 'none';
    document.getElementById('drivercomplaintopasschedule').style.display = 'none';
    document.getElementById('drivertopasslistofsetteldcomp').style.display = 'none';
}
function showAdmin() {
...
function showcomplainabotyou(){
    ...
    document.getElementById('ScheduledComplein-table').style.display = 'none';
    document.getElementById('ScheduledComplein-tablecaseclose').style.display = 'none';
    document.getElementById('drivercomplainaboutyou').style.display = 'block';
    document.getElementById('drivertopasslistofsetteldcomp').style.display = 'block';
    document.getElementById('drivercomplaintopasschedule').style.display = 'block';
