...
<button type="button" class="btn btn-danger btn-sm m-1" data-toggle="modal"  data-target="#edirnews">
    <i class="bi bi-trash"></i> Edit
</button>

<button type="button" class="btn btn-secondary btn-sm m-1" data-toggle="modal" data-target="#deletenews">
