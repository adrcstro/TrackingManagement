...
<div class="container mt-5 mb-5">
    <div class="row">
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            // Add the copy icon
            echo '<div class="copy-icon"><i class="bi bi-clipboard" onclick="copyToClipboard(' . "'" . $drivername . "'" . ')"></i></div>';

            // Add the location icon
            echo '<div class="location-icon"><i class="bi bi-geo-alt"></i></div>';
...
<!-- Add this script for copying to clipboard functionality -->
<script>
