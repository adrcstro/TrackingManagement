...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            // First column with color
            $pdf->Cell($pdf->GetPageWidth() / 2, 10, 'Table Header 1', 1, 0, 'C', 1);
            // Second column with color
            $pdf->Cell($pdf->GetPageWidth() / 2, 10, 'Table Header 2', 1, 1, 'C', 1);
            
            // First row, first column without color
            $pdf->Cell($pdf->GetPageWidth() / 2, 10, 'Table Data 1', 1, 0, 'C');
            // First row, second column without color
            $pdf->Cell($pdf->GetPageWidth() / 2, 10, 'Table Data 2', 1, 1, 'C');
