...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $searchID = isset($_POST["SearchReport"]) ? $_POST["SearchReport"] : null;
...
$driverInfoResult = $conn->query($driverInfoQuery);
    ...
    if ($driverInfoResult->num_rows > 0) {
        ...
        $pdf->Cell(90, 10, "Name: " . $driverInfo['Name'], 1, 1, 'L');
        $pdf->Cell(90, 10, "Age: " . $driverInfo['Age'], 1, 1, 'L');
        $pdf->Cell(90, 10, "Gender: " . $driverInfo['Gender'], 1, 1, 'L');
        $pdf->Cell(90, 10, "Phone: " . $driverInfo['Phone'], 1, 1, 'L');
