...
<div class="formsignin">
  ...
  <input class="form-control" type="file" id="DriversLicense" accept=".jpg, .png .jpeg .pdf" title="Please ensure the image is clear and legible" class="custom-title">
</div>

<div id="Filefield" class="input-wrap">
  <label for="formFile" class="custom-label">Vehicle Registration</label>
  <input class="form-control" type="file" id="VehicleRegistration" accept=".jpg, .png .jpeg .pdf" title="Please ensure the image is clear and legible" class="custom-title">
</div>
<div id="Filefield" class="input-wrap">
  <label for="formFile" class="custom-label">Permit to Operate</label>
  <input class="form-control" type="file" id="PermittoOperate" accept=".jpg, .png .jpeg .pdf" title="Please ensure the image is clear and legible" class="custom-title">
</div>
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.7.1/jquery.min.js"></script>
    ...
    $("#DriversLicense").change(function(){
...
$(document).ready(function(){
    $("#VehicleRegistration").change(function(){
        var file = $(this).prop('files')[0];
        console.log('File name: ' + file.name);
        console.log('File type: ' + file.type);
        console.log('File size: ' + file.size + ' bytes');
...
$(document).ready(function(){
    $("#PermittoOperate ").change(function(){
        var file = $(this).prop('files')[0];
        console.log('File name: ' + file.name);
        console.log('File type: ' + file.type);
        console.log('File size: ' + file.size + ' bytes');
