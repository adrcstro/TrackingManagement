    ...
    <?php
        ...
        if ($result) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<h6 class="card-title">Drivers Name:' . $drivername . '</h6>';
                echo '<h6 class="card-title">Drivers Vehicle Number: ' . $ViehicleNumber . '</h6>';
                echo '<h6 class="card-title">Drivers Plate Number:' . $PlateNumber . '</h6>';
