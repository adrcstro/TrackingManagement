...
if (isset($_POST['input1']) && isset($_POST['input2']) && isset($_POST['datePicker']) && isset($_POST['input3'])) {
...
<script>
    $(document).ready(function(){
        // Handling the 'Create' button click
        $("#createButton").click(function(){
            // Your code to handle the 'Create' button click
            // Make sure to include the logic to open the modal
        });
        ...
        // Handling the form submission for the 'Create' operation
        $("#Register").click(function(){
            ...
            $.post("your_combined_php_file.php", // Replace with your actual PHP file name
            {
                input1: input1,
                input2: input2,
                datePicker: datePicker,
                input3: input3,
                operation: 'create' // Add an operation flag to differentiate the operations
            },
        ...
        // Handling the form submission for the 'Update' operation
        $("#update").click(function(){
            var input1 = $("select[name='input1']").val();
            var input2 = $("input[name='input2']").val();
            var datePicker = $("input[name='datePicker']").val();
            var input3 = $("input[name='input3']").val();
            $.post("your_combined_php_file.php", // Replace with your actual PHP file name
            {
                ...
                datePicker: datePicker,
                input3: input3,
                operation: 'update' // Add an operation flag to differentiate the operations
            },
            function(data, status){
                Swal.fire({
                    title: 'Success!',
