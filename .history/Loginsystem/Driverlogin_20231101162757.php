...
<div class="formsignin">
  ...
  <input class="form-control" type="file" id="DriversLicense" accept=".jpg, .png .jpeg .pdf, .doc, .docx" title="Please ensure the image is clear and legible" class="custom-title">
</div>

<div id="Filefield" class="input-wrap">
  <label for="formFile" class="custom-label">Vehicle Registration</label>
  <input class="form-control" type="file" id="VehicleRegistration" accept=".jpg, .png .jpeg .pdf, .doc, .docx" title="Please ensure the image is clear and legible" class="custom-title">
</div>
<div id="Filefield" class="input-wrap">
  <label for="formFile" class="custom-label">Permit to Operate</label>
  <input class="form-control" type="file" id="PermittoOperate" accept=".jpg, .png .jpeg .pdf, .doc, .docx" title="Please ensure the image is clear and legible" class="custom-title">
</div>
