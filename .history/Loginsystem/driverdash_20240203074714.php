...
<div class="modal fade" id="drivercomplainreport">
    ...
    <label for="SearchReportpassenger">Select Complaint ID</label>
<select name="SearchReportpassenger" id="SearchReportpassenger" class="form-control" required>
    <option value="" disabled selected>Select an option</option>
    <?php
// Replace with your actual database credentials
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        searchInput.addEventListener("select", function() {
            ...
            if (searchText.length > 0) {
                fetch(`Complaindetails.php?seleact=${searchText}`)
