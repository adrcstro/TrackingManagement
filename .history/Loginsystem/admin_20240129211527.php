...
?>            
                    ...
                    <button type="button" class="btn btn-success  btn-sm w-70 mb-2" data-toggle="modal" data-target="#ProcessComplain" >
                    <i class="bi bi-file-earmark-plus"></i> Process Complain
</button>
                    <button type="button" class="btn btn-primary  btn-sm w-70 mb-2" data-toggle="modal" data-target="#ComplainUpdate">
    <i class="bi bi-arrow-up"></i> Modify
</button>

<button type="button" class="btn btn-danger  btn-sm w-70 mb-2" data-toggle="modal"  data-target="#Complaindelete">
    <i class="bi bi-trash"></i> Remove
</button>

<button type="button" class="btn btn-secondary  btn-sm w-70 mb-2" data-toggle="modal" data-target="#ComplaintView">
    <i class="bi bi-file-text"></i> View Report
</button>


<button type="button" class="btn btn-info  btn-sm w-70 mb-2" id="refreshButton4">
    <i class="bi bi-arrow-clockwise"></i> Refresh
</button>
