...
<div class="modal fade" id="drivercomplainreport">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <label for="Selectreport">Select Complaint ID</label>
<select name="Selectreport" id="Selectreport" class="form-control" required>
    <option value="" disabled selected>Select an option</option>
    ...
    $complaintSql = "SELECT * FROM complainttbl WHERE ComplainStatus = ''";
    ...
    if ($complaintResult->num_rows > 0) {
        ...
        echo '<option disabled>No complaints found</option>';
    }
