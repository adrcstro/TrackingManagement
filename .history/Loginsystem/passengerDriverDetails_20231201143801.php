...
echo '<button class="btn btn-outline-secondary" type="button" id="button-addon2" onclick="updateSearchBar()">Select</button>';
echo '</div>';
...
function updateSearchBar() {
    // Get the value from the driver name input
    var driverName = document.querySelector('.form-control').value;

    // Update the search bar input with the driver name
