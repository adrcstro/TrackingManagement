...
<div class="modal fade" id="Drivertrack">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="row">
    <div class="col-2">
        <button type="button" class="btn btn-outline-secondary btn-sm m-1" data-toggle="modal" data-target="#rate1Star">
            <i class="bi bi-star"></i> 1 Star
        </button>
    </div>

    <div class="col-2">
        <button type="button" class="btn btn-outline-secondary btn-sm m-1" data-toggle="modal" data-target="#rate2Stars">
            <i class="bi bi-star"></i> 2 Stars
        </button>
    </div>

    <div class="col-2">
        <button type="button" class="btn btn-outline-secondary btn-sm m-1" data-toggle="modal" data-target="#rate3Stars">
            <i class="bi bi-star"></i> 3 Stars
        </button>
    </div>

    <div class="col-2">
        <button type="button" class="btn btn-outline-secondary btn-sm m-1" data-toggle="modal" data-target="#rate4Stars">
            <i class="bi bi-star"></i> 4 Stars
        </button>
    </div>

    <div class="col-2">
        <button type="button" class="btn btn-outline-secondary btn-sm m-1" data-toggle="modal" data-target="#rate5Stars">
