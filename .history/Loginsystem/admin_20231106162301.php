...
<script>
        ...
        <label id="PassengerName" for="PassengerName">Name</label>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $updated_PassengerName = $_POST['PassengerName'];
    $updated_PassengerAge = $_POST['PassengerAge'];
    $updated_PassengerGender = $_POST['PassengerGender'];
    $updated_PassengerPhone = $_POST['PassengerPhone'];
    $updated_PassengerAddress = $_POST['PassengerAddress'];
    $updated_PassengerEmail = $_POST['PassengerEmail'];


    if (!empty($updated_admin)) {
        $sql = "UPDATE passengertbl SET Name='$PassengerName', Age='$PassengerAge', Gender='$PassengerGender', Phone='$PassengerPhone', HomeAddress='$PassengerAddress' , Username='$PassengerEmail'                 WHERE Admin='$updated_admin'";
