...
<div class="modal fade" id="Drivertrack">
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-2 text-center">
            <button type="button" class="btn btn-outline-secondary btn-sm m-1 custom-rating-button" data-toggle="modal" data-target="#rate4Stars">
                <i class="bi bi-star"></i> Very Good
            </button>
        </div>

        <div class="col-2 text-center">
            <button type="button" class="btn btn-outline-secondary btn-sm m-1 custom-rating-button" data-toggle="modal" data-target="#rate5Stars">
