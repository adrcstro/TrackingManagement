...
<main>
    ...
    <button  type="button"  aria-expanded="false" id="loginDropdownn">
       UserType:
        <select class="dropdown-menu"  bg-light-gray name="usertype" id="usertype">
            <option class="dropdown-item"  value="admin">Admin</option>
            <option class="dropdown-item"  value="driver">Driver</option>
            <option class="dropdown-item"  value="passenger">Passenger</option>
        </select>
    </button>
