...
?>
                    ...
                    <button type="button" class="btn btn-success btn-sm m-1" data-toggle="modal" data-target="#myModal" name="createButton">
    <i class="bi bi-plus-circle"></i> Create
</button>


<button type="button" class="btn btn-warning btn-sm m-1" data-toggle="modal" data-target="#update" id="updateButton" name="updateButton">
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['Register'])) {
        ...
        $updated_admin = $_POST['input6'];
        $updated_username = $_POST['input5'];
        $updated_date = $_POST['datePickers'];
        $updated_password = $_POST['input4'];
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="updateForm" action="admin.php" method="POST"">
                    <div class="form-group">
                        <label for="input6">Select BRGY-ADMIN</label>
                        <select name="input6" id="input6" class="form-control" required>
                    ...
                    <div class="form-group">
                        <label id="input5" for="input5">Update Username</label>
                        <input type="text" name="input5" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label id="datePickers" for="datePickers">Update Select Date</label>
                        <input name="datePickers" type="date" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label id="input4" for="input4">Update Password</label>
                        <input name="input4" type="text" class="form-control" required>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
...
<script> $("#Update").click(function(){
            var input6 = $("input[name='input6']").val();
            var input5 = $("input[name='input5']").val();
            var datePickers = $("input[name='datePickers']").val();
            var input4 = $("input[name='input4']").val();
            $.post("admin.php", // Replace with the actual file name for update
            {
                input6: input6,
                input5: input5,
