...
<main>
        ...
        <div class="inner-box">
          <div class="forms-wrap">
            <form id="clear"  action="<?php echo $_SERVER['PHP_SELF']; ?>" autocomplete="off" method="post" class="sign-in-form"   >
              ...
              <select class="form-select" name="usertype" id="usertype" onchange="changeLoginType(this.value)">
    ...
    <script>
        function changeLoginType(value) {
            document.getElementById('selectedType').innerText = value.charAt(0).toUpperCase() + value.slice(1);
        }
    </script>
