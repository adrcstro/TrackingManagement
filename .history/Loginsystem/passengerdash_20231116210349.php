...
<script type="text/javascript">
    $('#filereportRegister').click(function (e) {
        ...
        // Function to get file format
        function getFileFormat(fileInputId) {
            var fileName = $(fileInputId).val();
            // Extract file extension (format) from the file name
        ...
        var formData = {
            ...
            Fileinput6: getFileFormat('#Fileinput6'), // Get file format instead of the full path
