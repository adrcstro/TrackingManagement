...
echo ' <input type="text" id="Username" value="Driver Name:' . $row["Username"] .  '" readonly style="flex: 1; border: 1px solid #ccc; padding: 5px; margin-bottom: 10px; border-radius: 5px;">';
echo ' <i class="fas fa-copy" style="margin-left: 10px; cursor: pointer;" onclick="copyToClipboard(\'Username\')"></i>';
echo '</div>';
