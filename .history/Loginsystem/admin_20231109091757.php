        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="updateForm" action="driverupdate.php" method="post" enctype="multipart/form-data">
                    ...
                    <input type="text" name="SelectDriver" id="SelectDriver" class="form-control" required>
                </form>
            </div>
            <div class="modal-footer">
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        $data[] = array("id" => $row["Username"], "text" => $row["Username"]);
    }
} else {
    $data[] = array("id" => null, "text" => "No results found");
}
