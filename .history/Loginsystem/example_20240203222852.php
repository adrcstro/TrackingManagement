...
<div   id="issuewarning" style="display:none;" class="card shadow border-0 mb-7">
    ...
    <i class="bi bi-plus-circle"></i> Issue Warning
</button>
...
if ($result) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        if ($complaintResult) {
            ...
            if ($numComplaints >= 3) {
                // Display Bootstrap Warning Icon
                echo '<div style="margin-top: 30px;">'; // Add margin for spacing
                echo '<i class="bi bi-exclamation-triangle text-warning" title="Warning: 3 or more complaints"></i>';
                echo '</div>';
            }
