...
$loggedInUserID = isset($_GET['Id']) ? $_GET['Id'] : null;
$loggedInUsername = isset($_GET['Username']) ? $_GET['Username'] : null;

// Check if both CustomerID and username are present
if ($loggedInUserID !== null && $loggedInUsername !== null) {
    $query = "SELECT Name, Age, Gender, Phone, HomeAddress FROM passengertbl WHERE Id = '$loggedInUserID'";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        echo "</div>";
        echo "<div class='mb-3'>";
        echo "<input type='text' id='customerID' value='CustomerID: $loggedInUserID' class='form-control' readonly>";
        echo "</div>";
        echo "<div class='mb-3'>";
        echo "<input type='text' id='email' value='Email: {$userData['Age']}' class='form-control' readonly>";
        echo "</div>";
        echo "<div class='mb-3'>";
        echo "<input type='text' id='phone' value='Phone: {$userData['Gender']}' class='form-control' readonly>";
        echo "</div>";
        echo "<div class='mb-3'>";
        echo "<input type='text' id='homeAddress' value='HomeAddress: {$userData['Phone']}' class='form-control' readonly>";
        echo "</div>";
        echo "<div class='mb-3'>";
    ...
    // CustomerID or username missing, redirect to login
