    ...
    <nav class="navbar show navbar-vertical h-lg-screen navbar-expand-lg px-0 py-3 navbar-light bg-white border-bottom border-bottom-lg-0 border-end-lg" id="navbarVertical">
        ...
        <li class="nav-item">
            <a id="hide-table-link" class="nav-link" href="#" onclick="showPassengers()">
                <i class="bi bi-people"></i> Personal Details
            </a>
        </li>     
         <li class="nav-item">
                        <a class="nav-link" href="#" onclick="showDriver()">
                            <i class="bi bi-car-front"></i> TODA Drivers
...
<div class="modal" id="FileReport">
    ...
    <label id="input1" for="input1">Type of Complaint</label>
    <select name="input1" class="form-control" required>
        <option value="" selected disabled>Select a complaint type</option>
        <option value="overcharging">Overcharging: Drivers charging fares that exceed the standard rates.</option>
        <option value="refusal_service">Refusal to Provide Service: Drivers refusing to take passengers to certain destinations or short-distance trips.</option>
        <option value="reckless_driving">Reckless Driving: Complaints about tricycle drivers not adhering to traffic rules and driving recklessly.</option>
        <option value="vehicle_condition">Vehicle Condition: Tricycles in poor condition, such as malfunctioning brakes or lights.</option>
        <option value="unprofessional_behavior">Unprofessional Behavior: Complaints about rude or disrespectful behavior from tricycle drivers.</option>
        <option value="overloading">Overloading: Tricycles carrying more passengers than the allowed capacity.</option>
        <option value="route_deviation">Route Deviation: Drivers taking longer routes to increase the fare.</option>
        <option value="lack_of_safety_measures">Lack of Safety Measures: Tricycles without proper safety features, such as seat belts or helmets.</option>
        <option value="noise_and_air_pollution">Noise and Air Pollution: Excessive noise or emissions from tricycle engines.</option>
        <option value="unsanitary_conditions">Unsanitary Conditions: Dirty or unclean tricycle interiors.</option>
        <option value="inadequate_lighting">Inadequate Lighting: Lack of proper lighting on tricycles, especially at night.</option>
...
<script>
    function redirect() {
        ...
        window.open('https://www.google.com/maps/dir/Brgy.+409,+Sampaloc,+Manila,+Metro+Manila//@14.6021354,120.956025,13z/data=!4m8!4m7!1m5!1m1!1s0x3397c9fb6c83552d:0x54ad786f735dc69e!2m2!1d120.9973109!2d14.602139!1m0?entry=ttu', '_blank');
    }
</script>
