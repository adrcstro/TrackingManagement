...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
           ...
           // Original 'Proof of Identity' cell
$pdf->Cell(100, 10, 'Proof of Identity', 1, 0, 'C', 1);

// New cell for the additional column
$pdf->Cell(90, 10, 'New Column Header', 1, 1, 'C', 1);
...
if ($driverInfoResult->num_rows > 0) {
    ...
    $pdf->Cell(100, 10, "Proof of Identity", 1, 0, 'C');
    $pdf->Cell(90, 10, "New Column Data", 1, 1, 'C'); // Move to the next line
    $pdf->Cell(90, 10, "Vehicle Number: " . $driverInfo['Age'], 1, 0, 'C');
    $pdf->Cell(100, 10, "Existing Column Data", 1, 0, 'C');
    $pdf->Cell(90, 10, "New Column Data", 1, 1, 'C'); // Move to the next line
