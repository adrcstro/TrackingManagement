...
if ($type === 'license') {
    ...
    echo '<a href="uploads/' . $id . '" download="DriversLicense" class="btn btn-primary mt-3">Download Driver\'s License</a>';
    echo '</div>';
    ...
    echo '</div>';
    echo '<br>'; // Add a line break
    // Add Bootstrap button to download Vehicle Registration with margin-top
    echo '<a href="uploads/' . $id . '" download="VehicleRegistration" class="btn btn-primary mt-3">Download Vehicle Registration</a>';
} else {
