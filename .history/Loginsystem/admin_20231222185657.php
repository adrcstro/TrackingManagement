    ...
    <?php
        ...
        if ($result) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<div class="card rounded-3 border-0">';
                echo '<div class="position-relative overflow-hidden">';
                echo '<img src="uploads/' . $image . '" class="card-img-top rounded-3" alt="Card Image">';
                echo '<div class="overlay"></div>';
                echo '<div class="card-img-overlay text-white">';
                echo '<p class="card-text"><small class="text-muted">' . $time . ' | ' . $date . '</small></p>';
                echo '<h5 class="card-title display-5">' . $header . '</h5>';
                echo '</div>';
                echo '</div>';
                echo '<div class="card-body">';
                $trimmed_body = strlen($body) > 90 ? substr($body, 0, 90) . '...' : $body;
                echo '<p class="card-text mt-3 text-muted">' . $trimmed_body . ' <a href="#" class="read-more text-decoration-none" data-toggle="modal" data-target="#readMoreModal' . $row['NewsID'] . '">Read More</a></p>';
                echo '</div>';
                echo '</div>';
                echo '</div>';
                ...
                echo '<div class="modal-content rounded-3">';
                ...
                echo '<p class="lead text-dark">' . $body . '</p>';
                echo '</div>';
                echo '</div>';
                echo '</div>';
                echo '</div>';
