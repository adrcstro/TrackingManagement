...
if (isset($_GET['username'])) {
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            // Add the blank image box and the "Add Image" button with a plus icon
            echo "<div class='row'>";
            echo "<div class='col-md-6 mb-3'>";
            echo "<label for='image'>Image:</label>";
            echo "<div class='image-box'></div>"; // Blank image box, you can style this div as needed
            echo "<button class='btn btn-success' id='addImageButton'>Add Image <i class='fa fa-plus'></i></button>";
            echo "</div>";
            echo "</div>";
