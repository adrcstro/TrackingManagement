...
// Function to handle form submission and update the chart using AJAX
function searchAndUpdateChart() {
    ...
    // Send a POST request with the search term
    xhr.open("POST", "", true);
    xhr.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    xhr.send("search=" + searchTerm);
}

// Function to update the chart with the provided data
function updateChartWithData(newData) {
    // Update the global data variable
    data = newData;

    // Destroy the existing chart and redraw with updated data
    myChart.destroy();
    drawChart();
}
