...
<div class="modal" id="update">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="updateForm" action="admin.php" method="POSTT"">
                    <div class="form-group">
...
if ($_SERVER["REQUEST_METHOD"] == "POSTT") {
    $updated_admin = $_POSTT['input1'];
    $updated_username = $_POSTT['input2'];
    $updated_date = $_POSTT['datePicker'];
    $updated_password = $_POSTT['input3'];
...
<script> $("#Update").click(function(){
            ...
            var datePicker = $("input[name='datePicker']").val();
            var input3 = $("input[name='input3']").val();
            $.post("update.php", // Replace with the actual file name for update
            {
                input1: input1,
                input2: input2,
                datePicker: datePicker,
