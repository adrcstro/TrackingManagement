...
echo '<img src="uploads/' . $image . '" class="card-img-top rounded-top" alt="Card Image">';
echo '<div class="overlay bg-dark"></div>';
...
echo '<h5 class="modal-title text-dark">' . $header . '</h5>';
