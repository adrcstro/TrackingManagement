...
<div class="modal fade" id="Drivertrack">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <span id="selectedStarValue"></span>

<button type="button" id="Rate" class="btn btn-outline-secondary btn-sm m-1 custom-btn" data-toggle="modal" data-target="#rate1Star" onclick="showCommentsArea(1)">
    <i class="bi bi-star"></i> 1 Star
</button>

<button type="button" id="Rate" class="btn btn-outline-secondary btn-sm m-1 custom-btn" data-toggle="modal" data-target="#rate2Stars" onclick="showCommentsArea(2)">
    <i class="bi bi-star"></i> 2 Stars
</button>

<button type="button" id="Rate" class="btn btn-outline-secondary btn-sm m-1 custom-btn" data-toggle="modal" data-target="#rate3Stars" onclick="showCommentsArea(3)">
    <i class="bi bi-star"></i> 3 Stars
</button>

<button type="button" id="Rate" class="btn btn-outline-secondary btn-sm m-1 custom-btn" data-toggle="modal" data-target="#rate4Stars" onclick="showCommentsArea(4)">
    <i class="bi bi-star"></i> 4 Stars
</button>

<button type="button" id="Rate" class="btn btn-outline-secondary btn-sm m-1 custom-btn" data-toggle="modal" data-target="#rate5Stars" onclick="showCommentsArea(5)">
...
<script>
    function showCommentsArea(starValue) {
        // Show the comments area when a button is clicked
        document.getElementById('commentsArea').style.display = 'block';

        // Set the selected rating in the hidden field
        document.getElementById('SelectedRating').value = starValue;

        // Display the selected star value
        document.getElementById('selectedStarValue').innerHTML = "Selected Star Value: " + starValue;
    }

    function setRating(rating) {
        // Set the selected rating in the hidden field and visually indicate the selected rating
...
<div id="commentsArea" style="display:none; width: 80%; margin: 0 auto;">
    ...
    <textarea class="form-control mx-auto" id="comments" style="width: 100%;" placeholder="Comments"></textarea>
        ...
        $("#submitRatingButton").click(function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    alert(response); // You can replace this with your own logic (e.g., show a success message)
                },
                error: function () {
                    // Handle errors
