...
<div class="modal" id="FileReport">
    ...
    <form  id="clear" action="Filereport.php" enctype="multipart/form-data" method="post">
...
<div class="form-group g-col-6 g-col-md-4">
    ...
    <div class="form-group g-col-6 g-col-md-4">
        <label id="Fileinput6" for="Fileinput6">Submit Any Prof To Identify Driver</label>
        <input name="Fileinput6" type="file" class="form-control" required>
    </div>
...
<div class="modal-footer">
    ...
    <button id="filereportRegister" type="button" value="Submit" class="btn btn-danger">
   ...
   $(function(){
    $('#filereportRegister').click(function(e){
        ...
        if(valid){
            ...
            formData.append('Fileinput6', $('#Fileinput6')[0].files[0]);
