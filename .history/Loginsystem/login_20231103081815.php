...
<main>
    ...
    <ul class="dropdown-menu" name="usertype" id="usertype">
        <li value="passenger"><a class="dropdown-item" href="#" onclick="changeLoginType('Passenger')">Passenger</a></li>
        <li value="driver"><a class="dropdown-item" href="#" onclick="changeLoginType('Driver')">Driver</a></li>
        <li value="admin"><a class="dropdown-item" href="#" onclick="changeLoginType('Admin')">Admin</a></li>
    </ul>
</div>
