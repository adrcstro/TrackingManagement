...
<main>
    ...
    <div class="dropdown">
        ...
        <ul class="dropdown-menu" aria-labelledby="loginDropdown">
            <li><a class="dropdown-item" href="#" data-value="passenger" onclick="changeLoginType('Passenger')">Passenger</a></li>
            <li><a class="dropdown-item" href="#" data-value="driver" onclick="changeLoginType('Driver')">Driver</a></li>
            <li><a class="dropdown-item" href="#" data-value="admin" onclick="changeLoginType('Admin')">Admin</a></li>
        </ul>
    </div>

    <script>
        // Transfer attributes and values from select to dropdown using jQuery
        $(document).ready(function () {
            var selectElement = $('#usertype');
            var dropdownButton = $('#loginDropdown');
            dropdownButton.attr('name', selectElement.attr('name'));
            dropdownButton.attr('id', selectElement.attr('id'));
            var dropdownMenu = $('.dropdown-menu');
            dropdownMenu.attr('aria-labelledby', selectElement.attr('id'));

            // Transfer values
            var options = selectElement.children('option');
            dropdownMenu.find('a').each(function (index) {
                $(this).attr('data-value', options.eq(index).val());
            });
        });
    </script>
<script>
