...
.location-icon {
    ...
    top: 10px;
    right: 10px;
    color: white; /* Assuming your background is dark; adjust color accordingly */
    font-size: 20px;
    cursor: pointer;
    z-index: 1;
}
...
echo '<i class="fas fa-map-marker-alt location-icon" onclick="showLocation(\'location' . $row['id'] . '\')"></i>';
