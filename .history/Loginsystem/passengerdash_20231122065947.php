...
<div class="modal fade" id="Drivertrack">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div id="Rate" style="width: 80%; margin: 0 auto;">
    <label for="Rate">Rate:</label>
    <textarea class="form-control mx-auto" name="Rate" id="Rate" style="width: 100%;" placeholder="Rate"></textarea>
...
<button type="button" class="btn btn-secondary btn-sm m-1 rounded-pill" id="copyButton" data-toggle="modal" data-dismiss="modal">
    <i class="fas fa-times"></i> Close
                    ...
                    <button id="PassengerRegister" type="button" class="btn btn-primary rounded-pill" >Save Passenger</button>
                </div>
