  ...
  <script type="text/javascript">
      $('#filereportRegister').click(function (e) {
        ...
        var formData = {
            ...
            datefilereport: $('#datefilereport').val(),
            Fileinput3: $('#Fileinput3').val(),
            Fileinput4: $('#Fileinput4').val(),
            Fileinput5: $('#Fileinput5').val(),
            Fileinput6: $('#Fileinput6').val(),
            PassSearchDriver: $('#PassSearchDriver').val()
