...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['Role'])) {
    ...
    switch ($Role) {
      case 'Passenger':
          ...
          $column7 = 'Email';
          $column8 = 'Password';
          $redirectPage = 'passengerdash.php';
          break;
      case 'Driver':
          $table = 'driverstbl';
          $column2 = 'Name'; // Change to the appropriate column name
          $column4 = 'PlateNumber'; // Change to the appropriate column name
          $redirectPage = 'driverdash.php';
          break;
      case 'Admin':
          $table = 'admintbl';
          $column2 = 'Username';
          ...
          break;
      default:
          error_log("Role value: " . $Role); // Add this line to log the value of $Role
          echo 'Invalid user type.';
          exit;
  }
    // SQL query to check user credentials
    $sql = "SELECT * FROM $table WHERE $column7 = '$Email' AND $column8 = '$Password' , $column2 = '$Name' AND $column4 = '$PlateNumber, $column2 = '$Username' AND $column3 = '$Password            ";
...
<script>
    function changeLoginType(role) {
        document.getElementById('loginDropdown').innerText = role;
