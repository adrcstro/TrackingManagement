...
<script>
  ...
  <input  class="form-control" type="file"  name="itemimage" accept=".jpg, .png .jpeg .pdf, .doc, .docx">
    ...
    <div class="modal fade" id="edititem">
        ...
        <div class="row">
            <div class="col-md-6">
            <label for="lostid">Search Item-ID</label>
                        <select name="lostid" id="lostid" class="form-control" required>
...
<div class="modal-footer">
  ...
  $(document).ready(function() {
    $("#lostitemUpdate").click(function() {
      var LostItemsID= $("#lostid").val();
      var ItemName = $("input[name='ItemName']").val();
      var ContactPhone = $("input[name='ContactPhone']").val();
      var Description = $("input[name='Description']").val();
      var LostLocation = $("input[name='LostLocation']").val();
      var LostDate = $("input[name='LostDate']").val();
