...
<!-- Include jQuery, Bootstrap JavaScript, and SweetAlert (if not already included) -->
...
<script>
    ...
    $(document).ready(function () {
        // Attach a click event listener to the trackButton
        $('#trackButton').on('click', function () {
            // Close the modal with ID "Drivertrack"
            $('#Drivertrack').modal('hide');
        });

        // Your existing copyButton functionality
        document.getElementById('copyButton').addEventListener('click', function () {
            // ... (your existing code for copying the address)
        });
    });
</script>
