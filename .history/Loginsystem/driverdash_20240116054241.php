...
if (isset($_GET['username'])) {
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<div class='mb-3'>";
            echo "<input type='text' id='Name' value='Driver Name: " . htmlspecialchars($row["Username"]) . "' class='form-control' readonly>";
            echo "</div>";
            echo "<div class='mb-3'>";
            echo "<input type='text' id='age' value='Age: " . htmlspecialchars($row["Age"]) . "' class='form-control' readonly>";
            echo "</div>";
            echo "<div class='mb-3'>";
            echo "<input type='text'  id='password' value='Plate Number: " . htmlspecialchars($row["Password"]) . "' class='form-control' readonly>";
            echo "</div>";
            echo "<div class='mb-3'>";
            echo "<input type='text' id='license' value='Drivers License" . htmlspecialchars($row["DriversLicense"]) . "' class='form-control' readonly>";
            echo "</div>";
            echo "<div class='mb-3'>";
            echo "<input type='text' id='registration' value='Vehicle Registration" . htmlspecialchars($row["VehicleRegistration"]) . "' class='form-control' readonly>";
            echo "</div>";
          
            echo "<div class='mb-3'>";
            echo "<input type='text' id='phone' value='Phone Number" . htmlspecialchars($row["PhoneNumber"]) . "' class='form-control' readonly>";
            echo "</div>";
            echo "<div class='mb-3'>";
