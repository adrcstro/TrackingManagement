...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
   ...
   // Move to the next line
            ...
            $driverInfoQuery = "SELECT Age, Password, PhoneNumber, HomeAddress, ProfofIdentity FROM driverstbl WHERE Username = '$complaineeName'";
            ...
            if ($driverInfoResult->num_rows > 0) {
                ...
                // Display Prof of Identity
                $pdf->Cell(100, 10, "Prof of Identity: ", 1, 0, 'C');
                
                // Construct the path to the image file in the 'uploads' folder
                $profImagePath = 'uploads/' . $driverInfo['ProfofIdentity'];
