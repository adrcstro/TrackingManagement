    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="ratingsModalLabel">Ratings</h5>


                <div style="padding: 50px; width: 650px; margin: auto;">
    <h1 style="text-align: center">Drivers Personal Rating Scale</h1>
