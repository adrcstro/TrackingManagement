...
<div class="d-flex flex-column flex-lg-row h-lg-full bg-surface-secondary">
    ...
    <div class="card shadow border-0">
     ...
     <div class="calculator-table card shadow border-0 mb-7" style="display:none;" id="calculator-table" style="display:flex;">
    ...
    <div class="table-responsive">
        <div class="calculator">
            ...
            <div class="map-container" style="flex: 1; margin-left: 15rem;">
                <iframe
                    width="50%"
                    height="300px"
