    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            if ($driverInfoResult->num_rows > 0) {
                ...
                $pdf->Cell(90, 10, "Plate Number: " . $driverInfo['Password'], 1, 1, 'C'); // Second cell in the second row
                $pdf->Cell(90, 10, "PhoneNumber: " . $driverInfo['PhoneNumber'], 1, 0, 'C'); // First cell in the third row
                $pdf->Cell(90, 10, "Address: " . $driverInfo['HomeAddress'], 1, 1, 'C'); // Second cell in the third row
