        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input name="Description" type="text-area" class="form-control" required>
                </div>
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <label id="FoundLocation" for="FoundLocation">Lost Location</label>
                    <input name="FoundLocation" type="text" class="form-control" required>
                </div>
                <div class="form-group">
                    <label id="FoundDate" for="FoundDate">Lost Date</label>
