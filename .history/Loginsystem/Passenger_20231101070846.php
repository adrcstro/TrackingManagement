      ...
      <div class="box">
        <div class="inner-box">
          <div class="forms-wrap">
            <form action="Passenger.php" autocomplete="off" method="post" class="sign-in-form">
...
<div class="formsignin">
  ...
  <div class="col-md-12">
    ...
    $(function(){
      ...
      var PhoneNumber = $('#firstname').val();
      var HomeAddress = $('#firstname').val();
      ...
      var Password    = $('#firstname').val();
				...
				$.ajax({
					type: 'POST',
					url: 'process.php',
				  data:{firstname: firstname,Age :Age ,Gender: Gender,PhoneNumber: PhoneNumber,HomeAddress: HomeAddress,Email: Email,Password: Password},
					success: function(data){
            swal("Good job!", "User Successfully Registerd.", "success");
