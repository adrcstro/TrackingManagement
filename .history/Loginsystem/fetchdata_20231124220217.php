    ...
    <?php
        ...
        if ($result) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                // Adding the transparent background button with the arrow icon
                echo '<a href="#" class="arrow-button" onclick="scrollToName(\'driverName' . $row['id'] . '\')"><i class="fas fa-arrow-right"></i></a>';
