...
<script>
        ...
        <div class="modal-dialog" id="lostandfound"  >
            <div class="modal-content">
                ...
                <form id="clear" action="process.php" method="post">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <div id="Filefield" class="input-wrap">
  <label for="itemimage" class="custom-label">Item Image</label>
  <input required class="form-control" type="file" id="itemimage" name="itemimage" accept=".jpg, .png .jpeg .pdf, .doc, .docx" title="Please ensure the image is clear and legible" >
</div>
