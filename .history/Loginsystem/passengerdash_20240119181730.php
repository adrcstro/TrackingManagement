...
if ($loggedInUserID !== null && $loggedInUsername !== null) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        echo "<input type='text' name='Placeemail' value='{$userData['Age']}' class='form-control'  style='background-color: #fff;'>";
        echo "</div>";
        echo "<div class='mb-3'>";
        echo "<label id='Placephone'  for='Placephone'><i class='fas fa-phone'></i> Phone</label>";
        echo "<input type='text' name='Placephone' value='{$userData['Gender']}' class='form-control' style='background-color: #fff;'>";
        echo "</div>";
        echo "<div class='mb-3'>";
        echo "<label id='PlacehomeAddress' for='PlacehomeAddress'><i class='fas fa-home'></i> Home Address</label>";
        echo "<input type='text' name='PlacehomeAddress' value='{$userData['Phone']}' class='form-control' style='background-color: #fff;'>";
        echo "</div>";
        echo "<div class='mb-3'>";
        echo "<label id='PlacehomeAddress' for='PlacehomeAddress'><i class='fas fa-home'></i> Home Address</label>";
        ...
        echo "<div class='mb-3'>";
        echo "<label id='PlacehomeAddress' for='PlacehomeAddress'><i class='fas fa-home'></i> Home Address</label>";
        echo "<input type='text' name='PlacehomeAddress' value='{$userData['Username']}' class='form-control' style='background-color: #fff;'>";
        echo "</div>";
        echo "</div>";
        echo "</div>";
        echo "</div>";
