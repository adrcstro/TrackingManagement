...
echo '  <input type="text" value="Driver Name: John Doe" class="form-control" aria-describedby="button-addon2">';
...
document.addEventListener('DOMContentLoaded', function () {
    // Find the button and input elements by their IDs
    var selectButton = document.getElementById('button-addon2');
    ...
    selectButton.addEventListener('click', function () {
        ...
        alert('Username copied to clipboard: ' + inputField.value);
    });
});
</script>