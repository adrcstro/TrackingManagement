...
<div class="d-flex flex-column flex-lg-row h-lg-full bg-surface-secondary">
    ...
    <div class="card shadow border-0">
     ...
     <<div class="calculator-table card shadow border-0 mb-7"style="display:none;"   id="calculator-table" style="display:flex; flex-direction: row;">
    ...
    <div class="map-container" style="width: 50%; margin-left: 10px;">
        <iframe
            width="100%"
            height="300px"
