    ...
    <div class="card-body">
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <input type="text" id="Name" value="<?php echo htmlspecialchars($row["id"]); ?>" class="form-control" readonly>
            </div>
            <!-- Add more fields for other personal information as needed -->
        </div>
    </div>
<div class="table-responsive">
<table class="table table-hover table-nowrap" >
...
if (isset($_GET['username'])) {
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<label for='Name'>Driver ID:</label>";
            echo "<input type='text' id='Name' value='" . htmlspecialchars($row["id"]) . "' class='form-control' readonly>";
            echo "</div>";
