...
if (isset($_GET['username'])) {
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<div class='image-box border rounded-circle p-3' style='display: inline-block; overflow: hidden; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);'>";
            echo '<img src="uploads/' . htmlspecialchars($row["Profile"]) . '" class="img-fluid mb-5 mt-2" style="width: 100px; height: 100px; border-radius: 50%; object-fit: cover; border: 2px solid #fff;">'; // Adjust the width and height as needed
            echo "</div>";
            echo "</div>";
            echo "</div>";
