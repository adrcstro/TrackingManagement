        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="updateForm" action="admin.php" method="POST"">
                    ...
                    <div class="form-group">
                        <label id="input7" for="input7">Update Username</label>
                        <input type="text" name="input7" class="form-control" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label id="input9" for="input9">Update Password</label>
                        <input name="input9" type="text" class="form-control" required>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
...
<script> $("#Update").click(function(){
            ...
            var input7 = $("input[name='input7']").val();
