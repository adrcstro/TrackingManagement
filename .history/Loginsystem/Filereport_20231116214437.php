...
if (isset($_POST['Fileinput1'], $_POST['datefilereport'], $_POST['Fileinput3'], $_POST['Fileinput4'], $_POST['Fileinput5'], $_POST['PassSearchDriver'])) {
    ...
    if ($stmt->execute()) {
        ...
        echo "Swal.fire('Success', 'Your Report created successfully. Your name serves as your Username and PlateNumber serves as your Password.', 'success');";
    } else {
        // Display SweetAlert error message
        echo "Swal.fire('Error', 'Error: " . $sql . "<br>" . $conn->error . "', 'error');";
    }
}
