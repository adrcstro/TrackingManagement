...
<main>
    ...
    <button class="btn dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false" id="loginDropdown">
       ...
       <ul class="dropdown-menu">
        <li ><a  value="passenger" class="dropdown-item" href="#" onclick="changeLoginType('Passenger')">Passenger</a></li>
        <li  ><a value="driver" class="dropdown-item" href="#" onclick="changeLoginType('Driver')">Driver</a></li>
        <li  ><a value="admin" class="dropdown-item" href="#" onclick="changeLoginType('Admin')">Admin</a></li>
    </ul>
    </button>
