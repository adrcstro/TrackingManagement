...
if (isset($_POST['Fileinput1'], $_POST['datefilereport'], $_POST['Fileinput3'], $_POST['Fileinput4'], $_POST['Fileinput5'], $_POST['Fileinput6'])) {
    ...
    $passSearchDriverFile = isset($_FILES['PassSearchDriver']['name']) ? $_FILES['PassSearchDriver']['name'] : '';
    $passSearchDriverTmp = isset($_FILES['PassSearchDriver']['tmp_name']) ? $_FILES['PassSearchDriver']['tmp_name'] : '';
