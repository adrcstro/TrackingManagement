...
<div class="formsignin">
  ...
  <input required class="form-control" type="file" id="DriversLicense" name="DriversLicense" accept="image/*.jpg, .png .jpeg .pdf, .doc, .docx" title="Please ensure the image is clear and legible" >
</div>

<div id="Filefield" class="input-wrap">
  <label for="VehicleRegistration" class="custom-label">Vehicle Registration</label>
  <input required class="form-control" type="file" id="VehicleRegistration" name="VehicleRegistration" accept="image/*.jpg, .png .jpeg .pdf, .doc, .docx" title="Please ensure the image is clear and legible" >
</div>
<div id="Filefield" class="input-wrap">
  <label for="PermittoOperate" class="custom-label">Vehicle Unit Apperance</label>
  <input required class="form-control" type="file" id="PermittoOperate" name="PermittoOperate" accept="image/*.jpg, .png .jpeg .pdf, .doc, .docx" title="Please ensure the image is clear and legible" >
</div>
