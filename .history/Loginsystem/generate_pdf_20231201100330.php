...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            $pdf->SetFillColor(200, 220, 255); // Set the background color for the cells

            // First column
            $pdf->Cell(0, 10, 'Table Header 1', 0, 1, 'L', 1); // First column with color
            $pdf->Cell(0, 10, 'Table Data 1', 0, 1, 'L'); // First column data
        
            // Second column
            $pdf->Cell(0, 10, 'Table Header 2', 0, 1, 'L', 1); // Second column with color
            $pdf->Cell(0, 10, 'Table Data 2', 0, 1, 'L'); // Second column data
        }
