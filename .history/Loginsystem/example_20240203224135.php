...
if ($result) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        $complaintQuery = "SELECT COUNT(*) AS numComplaints,ComplainStatus FROM complainttbl WHERE NameofComplainee = '" . mysqli_real_escape_string($your_db_connection, $drivername) . "'";
