...
echo '<p><input type="text" value="Plate Number: ' . $row["Passwrd"] . '" readonly style="border: 1px solid #ccc; padding: 5px; margin-bottom: 10px; border-radius: 5px; width: 300px;"></p>';
echo '</div>';
