...
<div   id="calculator-table" style="display:none" class="card shadow border-0 mb-7">
    ...
    <label id="calculator" for="distance">Distance (in kilometers):</label>
    <input type="number" id="distance" placeholder="Enter distance" step="0.1">

    <label for="fareRate">Fare Rate (per kilometer):</label>
    <input id="calculator" type="number" id="fareRate" placeholder="Enter fare rate">

    <button id="calculator" onclick="calculateFare()">Calculate Fare</button>
