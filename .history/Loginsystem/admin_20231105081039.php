...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $selectedAdmin = $_POST['adminSelect']; // Fetch the selected Admin from the dropdown

    $username = $_POST['input2'];
    $date_created = $_POST['datePicker'];
    $password = $_POST['input3'];

    $sql = "UPDATE admintbl SET Username='$username', Date_Created='$date_created', Password='$password' WHERE Admin='$selectedAdmin'";
    ...
    <div class="modal" id="update">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <!-- Modal Header -->
                <div class="modal-header">
                    <h4 class="modal-title">Update Adminstrator Information</h4>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
            ...
            <select name="adminSelect" class="form-control">
                <?php
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <button id="Register" type="button" class="btn btn-primary" onclick="saveData()">Save</button>
