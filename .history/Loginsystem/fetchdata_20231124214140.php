...
<div class="container mt-5 mb-5">
    <div class="row">
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo '<h6 class="card-title">Drivers Name: <span style="font-weight:normal;" id="driverName' . $row['id'] . '">' . $drivername . '</span>';
            
            // Add the copy icon and set the onclick event
            echo ' <i class="far fa-copy copy-icon" onclick="copyToClipboard(\'driverName' . $row['id'] . '\')"></i></h6>';
...
<script>
    function copyToClipboard(elementId) {
        ...
        // You can add some visual feedback that the text is copied, like a tooltip or alert
        alert('Copied: ' + text);
    }
</script>
