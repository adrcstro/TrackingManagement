...
<script>
  document.addEventListener("DOMContentLoaded", function() {
    // Check if the "Open Modal" button was clicked
  ...
  function shouldOpenModalOnLoad() {
    // Check if the modal was manually opened before
    return localStorage.getItem("driversRatingsModalOpenedManually") === "true";
  }
