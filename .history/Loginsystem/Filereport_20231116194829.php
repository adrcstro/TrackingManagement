...
if (isset($_POST['Fileinput1'], $_POST['datefilereport'], $_POST['Fileinput3'], $_POST['Fileinput4'], $_POST['Fileinput5'], $_FILES['Fileinput6'])) {
    ...
    $fileinput6 = $_FILES['Fileinput6']['name'];

    $passSearchDriverFile = $_FILES['Fileinput6']['name'];
    $passSearchDriverTmp = $_FILES['Fileinput6']['tmp_name'];

    // File upload functionality
    $passSearchDriver = isset($_FILES['Fileinput6']['name']) ? $_FILES['Fileinput6']['name'] : '';
