...
<div class="modal fade" id="deletfoundlostitem">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form  action="founditemsdelete.php" method="post">
                    <div class="form-group">
                        <label for="itemType">Delete Selected Item</label>
...
<script>
        $(document).ready(function() {
            $('#founditemDelete').submit(function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'founditemsdelete.php', // Make sure this is the correct path to your delete.php file
                    data: formData,
                    dataType: 'json', // Set the dataType to 'json' to parse the JSON response
                    success: function(response) {
                        showAlert(response.type, response.message);
