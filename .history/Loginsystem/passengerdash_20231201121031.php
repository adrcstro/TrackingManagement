...
<div class="form-group g-col-6 g-col-md-4">
    ...
    <div class="d-flex justify-content-center buttonsfoname" style="margin-top: 1rem;">
    <button type="button" class="btn btn-primary mr-2"><i class="bi bi-files"></i> Copy</button>
    <button type="button" class="btn btn-success"><i class="bi bi-clipboard-check"></i> Paste</button>
</div>
