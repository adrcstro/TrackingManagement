...
<button type="button" class="btn btn-primary btn-sm m-1" id="refreshButton4">
    <i class="bi bi-arrow-clockwise"></i> Refresh
</button>
...
<script>
    ...
    <div class="form-group">
        ...
        <input name="bodycontent" type="textarea" class="form-control" required>
    </div>
    <div class="form-group">
...
<div class="modal-footer">
<button type="button" class="btn btn-secondary" data-dismiss="modal" style="background-color: #yourColor;">
    <i class="fas fa-times"></i> Close
</button>

<button id="SaveNews" type="button" class="btn btn-primary" style="background-color: #yourColor;">
