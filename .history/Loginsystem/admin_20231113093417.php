...
<div class="d-flex flex-column flex-lg-row h-lg-full bg-surface-secondary">
    ...
    <div class="card shadow border-0">
     ...
     <div class="calculator-table" id="calculator-table" style="display:none;" class="card shadow border-0 mb-7">
    ...
    <div class="card-footer border-0 py-3 d-flex justify-content-between flex-wrap">
        <!-- New paragraph with the desired text -->
        <p style="font-weight: bold; text-align: right;">Check the Fare Rate in Every Destination</p>
    </div>
</div>
