...
if (isset($_GET['username'])) {
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo '<img src="uploads/' . htmlspecialchars($row["PermittoOperate"]) . '" class="img-fluid mb-3 mt-4 mb-md-0 mt-md-4" style="max-height: 300px;">';
            ...
            echo "<div class='image-box border rounded p-3 ' style='display: inline-block;'>";
