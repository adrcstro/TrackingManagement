...
$driverInfoResult = $conn->query($driverInfoQuery);
    ...
    if ($driverInfoResult->num_rows > 0) {
        ...
        $pdf->Cell(90, 10, "Vehicle Number: " . $driverInfo['Name'], 1, 1, 'L');
        $pdf->Cell(90, 10, "Plate Number: " . $driverInfo['Age'], 1, 1, 'L');
        $pdf->Cell(90, 10, "PhoneNumber: " . $driverInfo['Gender'], 1, 1, 'L');
        $pdf->Cell(90, 20, "Address: " . $driverInfo['Phone'], 1,1, 'L');
