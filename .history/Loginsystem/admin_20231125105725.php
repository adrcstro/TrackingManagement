...
<button data-toggle="modal" data-target="#Ratings" onclick="openRate()">Open Modal</button>
...
<script>
  document.addEventListener("DOMContentLoaded", function() {
    ...
    if (localStorage.getItem("RateOpened")) {
      openRate();
    }
  });
  ...
  function openRate() {
    ...
    localStorage.setItem("RateOpened", "true");
  }
  ...
  function closeRate() {
    ...
    localStorage.removeItem("RateOpened");
  }
</script>
