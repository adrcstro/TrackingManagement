...
if ($type === 'license') {
    ...
    echo '<a href="downloads/' . $id . '.pdf" class="btn btn-primary" download>Download Driver\'s License</a>';
    echo '</div>';
} elseif ($type === 'registration') {
    echo '<div style="text-align: center;">';
    echo '<p>Vehicle Registration: ' . $id . '</p>';
    // Retrieve and display the Vehicle Registration image
    echo '<img src="uploads/' . $id . '" alt="Vehicle Registration" style="display: block; margin: 0 auto; width: 600px; height: 400px;">';
    echo '<a href="downloads/' . $id . '.pdf" class="btn btn-primary" download>Download Vehicle Registration</a>';
    echo '</div>';
} else {
