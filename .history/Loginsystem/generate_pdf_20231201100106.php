...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            $pdf->Cell(0, 10, 'Table Header 1', 1, 1, 'C', 1); // First row, first column with color
            $pdf->Cell(0, 10, 'Table Header 2', 1, 1, 'C', 1); // First row, second column with color
        
            $pdf->Cell(0, 10, 'Table Data 1', 1, 1, 'C'); // Second row, first column
            $pdf->Cell(0, 10, 'Table Data 2', 1, 1, 'C'); // Second row, second column
