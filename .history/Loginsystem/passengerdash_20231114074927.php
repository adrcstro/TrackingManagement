...
<script>
    ...
    <div class="row justify-content-center">
        <div class="col-md-4 mb-4">
            <div class="card">
                <img src="../Images/h1.jpg" class="card-img-top img-fluid" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Poor Customer Service</h5>
                    <p class="card-text">Unprofessionalism can manifest through poor customer service, such as rude or disrespectful behavior from transport staff, including drivers, conductors, or customer service representatives.</p>
                    <div class="text-center">
                        <a href="#" class="btn btn-primary btn-sm mt-2">Go somewhere</a>
                    </div>
                </div>
            </div>
        </div>
