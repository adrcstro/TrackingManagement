...
// Input Fields
echo '<div class="grid" style="flex: 1; margin-right: 20px;">';
...
echo '<div class="g-col-4 images">';
echo '<img src="uploads/' . $row['PermittoOperate'] . '"
 style="border: 1px solid #ccc; border-radius: 5px; width: 350px; height: 250px;  margin-top: 2rem;">';
