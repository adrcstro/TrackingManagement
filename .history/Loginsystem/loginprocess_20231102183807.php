...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
   ...
   $PlateNumber = "Driversdata";
    ...
    $sql = "SELECT $column_name FROM $table_name WHERE username = ? AND password = ? AND Name = ? AND PlateNumber = ?";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("ssss", $username, $password,$Name,$PlateNumber);
    $stmt->execute();
