        ...
        <div class="inner-box">
          <div class="forms-wrap">
            <form id="clear"  action="<?php echo $_SERVER['PHP_SELF']; ?>" autocomplete="off" method="post" class="sign-in-form"   >
              ...
              <select class="dropdown" name="usertype" id="usertype" >
    <button class="btn dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false" id="loginDropdown">
        Login as
    </button>
    <ul class="dropdown-menu">
      
       <option> <li><a class="dropdown-item" value="passenger" href="#" onclick="changeLoginType('Passenger')">Passenger</a></li></option>
       <option>  <li><a class="dropdown-item" value="driver" href="#" onclick="changeLoginType('Driver')">Driver</a></li> </option> 
       <option>  <li><a class="dropdown-item" value="admin" href="#" onclick="changeLoginType('Admin')">Admin</a></li> </option> 
    </ul>
</select>
