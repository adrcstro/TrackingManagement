         ...
         <div class="accordion-item shadow">
          ...
          <div class="accordion-item bg-white shadow">
            ...
            <div id="flush-collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
              <div class="accordion-body">Tricycle operators should promptly inform local authorities or their respective tricycle associations about passengers exhibiting unruly behavior or violating safety regulations. Providing specific details about the incident, such as the time, location, and a description of the passengers involved, helps ensure appropriate action is taken to maintain order and safety within the tricycle community.</div>
            </div>
          </div>
          <div class="accordion-item shadow">
            <h2 class="accordion-header">
