    ...
    if ($result->num_rows > 0) {
      if ($result->num_rows > 0) {
        ...
        if ($usertype == 'admin') {
            ...
            echo '<script>';
            echo 'swal("Login Successful", "Redirecting to admin dashboard", "success").then((value) => {';
            echo '  window.location.href = "admin.php"; // Redirect to the admin dashboard page';
            echo '});';
            echo '</script>';
            exit();
        } elseif ($usertype == 'driver') {
            echo '<script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>';
            echo '<script>';
            echo 'swal("Login Successful", "Redirecting to driver dashboard", "success").then((value) => {';
            echo '  window.location.href = "driverdash.php"; // Redirect to the driver dashboard page';
            echo '});';
            echo '</script>';
            exit();
        } elseif ($usertype == 'passenger') {
            echo '<script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>';
            echo '<script>';
            echo 'swal("Login Successful", "Redirecting to passenger dashboard", "success").then((value) => {';
            echo '  window.location.href = "passengerdash.php"; // Redirect to the passenger dashboard page';
            echo '});';
            echo '</script>';
            exit();
        }
        ...
        echo '<script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>';
        echo '<script>';
        echo 'swal("Login Failed", "Please check your username and password", "error").then((value) => {';
