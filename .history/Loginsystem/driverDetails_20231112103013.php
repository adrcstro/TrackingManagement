...
echo '<button type="button" class="btn btn-primary btn-sm m-1" id="copyButton" data-toggle="modal" data-target="#copyModal" onclick="copyAddress(\'' . $row["HomeAddress"] . '\')"> <i class="fas fa-copy"></i> Copy Address</button>';
