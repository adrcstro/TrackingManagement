function showDriver() {
    ...
    document.getElementById('Scheduled-Complain').style.display = 'none';
    document.getElementById('Setteld-complain').style.display = 'none';
    document.getElementById('issuewarning').style.display = 'none';
}
...
function showComplaincenter(){
    ...
    document.getElementById('founditem').style.display = 'none';
    document.getElementById('waste-table').style.display = 'none';
    document.getElementById('Scheduled-Complain').style.display = 'block';
    document.getElementById('Setteld-complain').style.display = 'block';
    document.getElementById('issuewarning').style.display = 'none';
...
function showwarning(){
    ...
    document.getElementById('issuewarning').style.display = 'block';
...
function calculateFare() {
    ...
    if (isPWD) {
        discountMultiplier = 0.9; // 20% discount for PWD
    } else if (isStudent) {
        discountMultiplier = 0.9; // 10% discount for students
    } else if (isSeniorCitizen) {
        discountMultiplier = 0.9; // 15% discount for senior citizens
    }
