    ...
    if ($resultDriverName->num_rows > 0) {
        ...
        if ($resultRating->num_rows > 0) {
            ...
            while ($row = $resultRating->fetch_assoc()) {
                ...
                // Convert text rating to word rating
                switch ($textRating) {
                    case '1':
                        $wordRating = 'Very Poor';
                        break;
                    case '2':
                        $wordRating = 'Poor';
                        break;
                    ...
                    case '5':
                        ...
                        break;
                    default:
                        $wordRating = 'Unknown'; // Default to 'Unknown' if unknown rating
                }

                $wordRatings[] = [$customer, $wordRating];
            }
        } else {
...
var ratingsData = <?php echo json_encode($wordRatings); ?>;
...
var data = ratingsData.map(function(item) {
    // Use the word ratings instead of numeric values
    return item[1];
});
