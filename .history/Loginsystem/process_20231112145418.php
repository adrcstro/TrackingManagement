...
if (isset($_POST['Username'], $_POST['Age'], $_POST['Password'], $_POST['PhoneNumber'], $_POST['HomeAddress'])) {
    ...
    if ($stmt->execute()) {
        ...
        move_uploaded_file($permitToOperateTmp, "upload_directory/" . $permitToOperateFile);

        // Process Driver's License file
        move_uploaded_file($driversLicenseTmp, "upload_directory/" . $driversLicenseFile);
        
        // Process Vehicle Registration file
        move_uploaded_file($vehicleRegistrationTmp, "upload_directory/" . $vehicleRegistrationFile);
