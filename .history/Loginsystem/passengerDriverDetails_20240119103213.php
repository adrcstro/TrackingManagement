...
if (isset($_GET['search'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        <input type="text" id="Username" value="Driver Name: ' . $row["Username"] . '" readonly style="border: 1px solid #ccc; padding: 5px; margin-bottom: 10px; border-radius: 5px; width: 290px; display: inline-block;">
        <button onclick="copyText(\'Username\')" style="position: absolute; right: 5px; top: 50%; transform: translateY(-50%);">Copy</button>
      </p>';
