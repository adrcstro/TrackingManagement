...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            // Output the letter content to the first column of the PDF
            $pdf->MultiCell(0, 12, $letterContent);
            
            // Add a two-column box below
            $pdf->Rect(10, $pdf->GetY(), $pdf->GetPageWidth() - 20, 80); // Adjust dimensions as needed
            
            // Move to the second column
            $pdf->SetXY(20, $pdf->GetY() + 10);
            
            // Output the second column content (you can customize this column as needed)
            $pdf->MultiCell(($pdf->GetPageWidth() - 40) / 2, 12, "Second Column Content");
