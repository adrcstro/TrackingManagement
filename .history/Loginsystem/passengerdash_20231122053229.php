...
<div class="modal fade" id="Drivertrack">
    ...
    <button type="button" class="btn btn-outline-secondary btn-sm m-1 custom-btn" data-toggle="modal" data-target="#rate1Star">
        <i class="bi bi-star"></i> 1 Star
    </button>

    <button type="button" class="btn btn-outline-secondary btn-sm m-1 custom-btn" data-toggle="modal" data-target="#rate2Stars">
        <i class="bi bi-star"></i> 2 Stars
    </button>

    <button type="button" class="btn btn-outline-secondary btn-sm m-1 custom-btn" data-toggle="modal" data-target="#rate3Stars">
        <i class="bi bi-star"></i> 3 Stars
    </button>

    <button type="button" class="btn btn-outline-secondary btn-sm m-1 custom-btn" data-toggle="modal" data-target="#rate4Stars">
        <i class="bi bi-star"></i> 4 Stars
    </button>

    <button type="button" class="btn btn-outline-secondary btn-sm m-1 custom-btn" data-toggle="modal" data-target="#rate5Stars">
...
?>            
                    ...
                    <div class="card-footer border-0 py-3 d-flex justify-content-center flex-wrap">
<button type="button" btn-outline-secondary class="btn btn-warning btn-sm m-1" data-toggle="modal" data-target="#Passengerupdate">
    <i class="bi bi-pencil"></i> Update
</button>

<button type="button" btn-outline-secondary class="btn btn-danger btn-sm m-1" data-toggle="modal"  data-target="#passengerdelete">
    <i class="bi bi-trash"></i> Delete
</button>

 <button type="button" btn-outline-secondary class="btn btn-info btn-sm m-1" id="refreshButton2">
