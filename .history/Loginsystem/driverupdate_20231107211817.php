...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($selectedDriver)) {
        ...
        if ($stmt->execute()) {
            move_uploaded_file($_FILES['DriversDriversLicense']['tmp_name'], "upload/".$_FILES['DriversDriversLicense']['name']);
            move_uploaded_file($_FILES['DriverVehicleRegistration']['tmp_name'], "upload/".$_FILES['DriverVehicleRegistration']['name']);
            move_uploaded_file($_FILES['DriversPermittoOperate']['tmp_name'], "upload/".$_FILES['DriversPermittoOperate']['name']);
