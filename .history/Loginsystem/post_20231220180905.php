...
if (
    ...
    if (isset($_FILES['itemimage'])) {
        ...
        if ($stmt->execute()) {
            ...
            echo "<script>
                    ...
                    swal({
                        ...
                        console.log('SweetAlert success callback reached');
            ...
            echo "<script>
                    ...
                    swal({
                        title: 'Error',
                        text: 'There was an issue posting your item. Please try again.',
                        icon: 'error',
                    });
                 </script>";
        }
        ...
        // Display SweetAlert error message
        echo "<script>
                console.log('Reached file error block');
                swal({
                    title: 'Error',
                    text: 'itemImage key not found in the uploaded files.',
                    icon: 'error',
                });
             </script>";
    }
