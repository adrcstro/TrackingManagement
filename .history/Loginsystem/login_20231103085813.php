        ...
        <div class="inner-box">
          <div class="forms-wrap">
            <form id="clear"  action="<?php echo $_SERVER['PHP_SELF']; ?>" autocomplete="off" method="post" class="sign-in-form"   >
              ...
              <div class="dropdown">
    <button  type="button"  aria-expanded="false" id="loginDropdownn">
       UserType:
        <select  bg-light-gray name="usertype" id="usertype">
...
<script>
    ...
    if (dropdown.value === "admin") {
        // Change icon based on the user's choice
        icon.className = "fas fa-caret-square-down";
    } else if (dropdown.value === "driver") {
        // Change icon based on the user's choice
        icon.className = "fas fa-caret-square-right";
    } else if (dropdown.value === "passenger") {
        // Change icon based on the user's choice
        icon.className = "fas fa-caret-square-left";
    }
}
