    ...
    <div class="flex-container">
        <div class="table-responsive">
            <div class="calculator" style="flex: 1; padding-right: 20px;">
                ...
                <label class="Labelcalculator" for="meters">Distance (in meters):</label>
                <input class="Inputcalculator" type="number" id="meters" placeholder="Enter meters" step="1">
...
<div class="modal fade" id="Drivertrack">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <button type="button" class="btn btn-primary btn-sm m-1" id="trackButton" data-target="#maps" data-toggle="modal">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form method="POST" class="text-center mt-3" id="addressForm" style="margin-top: 20px;">
                        ...
                        <div class="form-group row justify-content-center">
                            <div class="col-sm-10">
                            <button type="button" class="btn btn-primary" onclick="updateMap()" style="margin-top: 20px;">
    Submit <i class="fas fa-check"></i>
</button>

<button type="button" class="btn btn-secondary ml-2" name="paste_address" style="margin-top: 20px;">
