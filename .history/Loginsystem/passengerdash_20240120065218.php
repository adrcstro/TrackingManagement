...
if (isset($_GET['NameofComplainee'])) {
    $nameofComplaineeParam = $_GET['NameofComplainee'];
    ...
    // Fetch data from the complainttbl, filtered by NameofComplainee
    ...
    $stmt->bind_param("s", $nameofComplaineeParam);
    $stmt->execute();
    $result = $stmt->get_result();
    ...
    echo "NameofComplainee not provided in the URL.";
}
?>
