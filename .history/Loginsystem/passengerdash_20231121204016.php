...
?>            
    ...
    <!-- Rating buttons -->
    <div class="mt-3">
        <label for="driverRating">Rate the Driver:</label>
        <div class="btn-group" role="group" aria-label="Driver Rating">
        ...
        <input type="hidden" name="driverRating" id="driverRating" value="0">
    </div>
</div>
...
<script>
    $(document).ready(function() {
        ...
        // Your existing script for other functionalities can go here
    });
</script>
