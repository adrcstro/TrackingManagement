...
<button type="button" class="btn btn-secondary btn-sm m-1" onclick="openModal()" data-toggle="modal" data-target="#RatingsDriver">
...
<div class="modal fade" id="RatingsDriver">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
...
<script>
  ...
  function openModal() {
    document.getElementById("RatingsDriver").style.display = "block";
  ...
  function closeModal() {
    document.getElementById("RatingsDriver").style.display = "none";
