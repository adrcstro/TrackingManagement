        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <form method="post" action="" class="mt-8">
                    ...
                    <input type="text" name="search" id="search" class="form-control mt-2">
                    <input type="submit" value="Search" class="btn btn-primary mt-2">
                </form>

                <!-- Input field for max value of left axis -->
                <label for="maxLeft" class="mt-8">Max for Left Axis:</label>
                <input type="number" name="maxLeft" id="maxLeft" value="5" class="form-control mt-2">

                <button onclick="updateChart()" class="btn btn-success mt-2">Update Chart</button>
            </div>

            <div class="col-md-6">
                <div style="width: 100%; height: 400px;" class="mt-4">
