...
if(isset($_POST['Name'], $_POST['Age'], $_POST['PlateNumber'], $_POST['PhoneNumber'], $_POST['HomeAddress'])){
    ...
    $driversLicense = saveUploadedFile('DriversLicense', $uploadDirectory);
    $vehicleRegistration = saveUploadedFile('VehicleRegistration', $uploadDirectory);
    $permittoOperate = saveUploadedFile('PermittoOperate', $uploadDirectory);
