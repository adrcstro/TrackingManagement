...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            $pdf->Cell(150, 10, 'Complainee Details', 1, 1, 'C', 1);
...
$driverInfoResult = $conn->query($driverInfoQuery);
    ...
    if ($driverInfoResult->num_rows > 0) {
        ...
        $pdf->Cell(150, 10, "Name: " . $driverInfo['Name'], 1, 1, 'L');
        $pdf->Cell(150, 10, "Age: " . $driverInfo['Age'], 1, 1, 'L');
        $pdf->Cell(150, 10, "Gender: " . $driverInfo['Gender'], 1, 1, 'L');
        $pdf->Cell(150, 10, "Phone: " . $driverInfo['Phone'], 1, 1, 'L');
        $pdf->MultiCell(150, 20, "Address: " . $driverInfo['HomeAddress'], 1, 'L');
