...
<head>
    ...
    <style>
        .card {
            height: 530px; /* Adjust the height to your desired value */
...
@media (max-width: 768px) {
    .read-more-btn {
        width: 150px; /* Adjust the width for smaller screens if necessary */
    }
}
    .read-more-btn i {
    ...
    .read-more-btn:hover {
        background: #603ce6; /* Change background color on hover */
