        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="updateForm" action="admin.php" method="post">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        <button id="Delete" type="submit" class="btn btn-danger" onclick="showAlert()">Delete</button>
                    </div>
                </form>
            </div>
        </div>
...
<script>
    function showAlert() {
        // Trigger SweetAlert notification based on the response from the PHP script
        swal({
