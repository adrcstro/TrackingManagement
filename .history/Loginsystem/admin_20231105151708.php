...
<div class="modal" id="update">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="updateForm" action="update.php" method="POST" style="display: none;">
                    <div class="form-group">
...
<script>
    // JavaScript to populate the update form and submit it when the update button is clicked
    $("#updateButton").click(function(){
        // Populate the hidden fields with the necessary data from the modal fields
        $("#updateInput1").val($("#input1").val());
        $("#updateInput2").val($("#input2").val());
        $("#updateDatePicker").val($("#datePicker").val());
        $("#updateInput3").val($("#input3").val());

        // Submit the form for the update operation
        $("#updateForm").submit();
    });
</script>
