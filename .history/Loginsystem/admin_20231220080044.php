  ...
  <div class="row justify-content-center">
    <div class="col-md-4">
      <div class="form-check d-inline-block mx-2">
        <input class="form-check-input" type="checkbox" id="isPWD">
        <label class="form-check-label" for="isPWD">PWD</label>
      </div>

      <div class="form-check d-inline-block mx-2">
        <input class="form-check-input" type="checkbox" id="isStudent">
        <label class="form-check-label" for="isStudent">Student</label>
      </div>

      <div class="form-check d-inline-block mx-2">
        <input class="form-check-input" type="checkbox" id="isSeniorCitizen">
