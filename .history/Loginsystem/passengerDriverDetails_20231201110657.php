...
echo '<img src="uploads/' . $row['PermittoOperate'] . '"
 ...
 echo '<div style="margin-top: -12rem; margin-left: -19rem; position: absolute; text-align: center;">';
 echo '<div style="display: inline-block; margin-right: 10px;">';
 echo '<button type="button" class="btn btn-primary"><i class="bi bi-files"></i> Copy</button>';
 echo '</div>';
 echo '<div style="display: inline-block;">';
 echo '<button type="button" class="btn btn-success"><i class="bi bi-clipboard-check"></i> Paste</button>';
 echo '</div>';
 echo '</div>';
