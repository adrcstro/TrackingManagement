...
echo '<img src="uploads/' . $row['PermittoOperate'] . '"
 ...
 echo '<button type="button" class="btn btn-primary mr-2"><i class="bi bi-files"></i> Copy</button>';
 echo '<button type="button" class="btn btn-success mr-2"><i class="bi bi-clipboard-check"></i> Paste</button>';
 echo '</div>';
