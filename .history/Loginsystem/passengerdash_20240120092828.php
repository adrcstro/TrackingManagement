...
echo '<select name="ComplaintID" id="ComplaintID" class="form-control" required>';
echo '<option value="" disabled selected>Select Report ID</option>'; // Default option
    ...
    if ($passengerResult->num_rows > 0) {
        ...
        if ($complaintResult->num_rows > 0) {
            while ($row = $complaintResult->fetch_assoc()) {
                ...
                echo '<option value="' . $complaintID . '">' . $complaintID . '</option>';
            }
        } else {
            echo "No complaints found for the passenger.";
        }
