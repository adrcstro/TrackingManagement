...
if (isset($_GET['search'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        <input type="text" id="Username" value="Driver Name: ' . $row["Username"] . '" <i class="fas fa-copy"></i> readonly style="border: 1px solid #ccc; padding: 5px; margin-bottom: 10px; border-radius: 5px; width: 300px;">
