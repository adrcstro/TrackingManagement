...
<div class="d-flex flex-column flex-lg-row h-lg-full bg-surface-secondary">
  ...
  <div class="row">
    <div class="col-md-3">
      <div class="card">
        <img src="../Images/s1.svg" class="card-img-top" alt="Card Image">
        <div class="card-body">
          ...
          <a href="#" class="btn d-inline-flex btn-sm btn-neutral border-base mx-1" data-toggle="modal"  onclick="showAdmin()">
        <span class="pe-2">
        <i class="bi bi-plus"></i>
     </span>
    ...
    <div class="col-md-3">
      <div class="card">
        <img src="../Images/s2.svg" class="card-img-top" alt="Card Image">
        <div class="card-body">
          <h5 class="card-title">Complain Report</h5>
          <p class="card-text">Manage Report Details</p>
          <div class="shortcutbtn mt-2 d-flex justify-content-center align-items-center">  
          <a href="#" class="btn d-inline-flex btn-sm btn-neutral border-base mx-1" data-toggle="close" data-target="#edit">
        <span class="pe-2">
        <i class="bi bi-plus"></i>
     </span>
    ...
    <div class="col-md-3">
      <div class="card">
        <img src="../Images/s3.svg" class="card-img-top" alt="Card Image">
        <div class="card-body">
    ...
    <div class="col-md-3">
      <div class="card">
        <img src="../Images/s4.svg" class="card-img-top" alt="Card Image">
        <div class="card-body">
