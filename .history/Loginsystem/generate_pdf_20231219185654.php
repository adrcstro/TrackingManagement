...
class PDF extends TCPDF {
    ...
    public function Header() {
        ...
        $this->Image($logoPath, 45, 8, 25); 
        $logoPath = '../Images/logomanila.jpg'; // Adjust the path based on your project structure
        $this->Image($logoPath, 140, 8, 23);// Adjust the coordinates and size as needed
        $this->Ln(9);
        // Organization details
        ...
        // Title
        $this->Cell(0, 10, 'Barangay-409 Sta Teresita ST Sampaloc Manila', 0, 1, 'C');
