...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            $letterContent .= "a complainant identified as <strong>" . $row['ComplainantName'] . "</strong>. The complainant, residing at " . $row['Address'] . " and reachable at " . $row['ContactNumber'] . ", reported an incident involving the complainee, " . $row['NameofComplainee'] . ".\n\n";
            
            $letterContent .= "In providing a comprehensive account of the incident, the complainant details are as follows:\n";
            $letterContent .= "Name: <strong>" . $row['ComplainantName'] . "</strong>. ";
