...
<script>
    ...
    // Modify the JavaScript function for updating search results
function updateSearchResults(driverInfo) {
    // Display the Name in the input field
    document.getElementById("SearchDriver").value = driverInfo.Name;

    // You can display other information as needed
    // For example: document.getElementById("VehicleNumberInput").value = driverInfo.VehicleNumber;
    //             document.getElementById("PlateNumberInput").value = driverInfo.PlateNumber;

    // Display the search results in a div (you may need to adjust this part based on your HTML structure)
    document.getElementById("searchResults").innerHTML = "Driver Name: " + driverInfo.Name + "<br>"
                                                        + "Vehicle Number: " + driverInfo.VehicleNumber + "<br>"
                                                        + "Plate Number: " + driverInfo.PlateNumber;
}
