...
<div class="col-xl-3 col-sm-6 col-12">
    <div class="card shadow border-2">
        <div class="card-body">
            ...
            <div class="mt-2 mb-0 text-sm text-center">
            <button type="button" class="btn d-inline-flex btn-sm btn-neutral border-base mx-1" title="The barangay officials diligently coordinated the schedules of the two parties involved, ensuring a mutually convenient time for them to meet and discuss the  issue." onclick="updateRating('Scheduled')">
    <i class="bi bi-arrow-up me-1"></i>Select
</button>
            </div>
        </div>
