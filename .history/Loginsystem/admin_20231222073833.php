    ...
    <div class="col-md-3">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <p class="card-text">Manage Administrator Details</p>
          <div class="shortcutbtn mt-3">  
          <a href="#" class="btn d-inline-flex btn-sm btn-neutral border-base mx-1 center" data-toggle="modal" data-target="#edit">
        <span class=" pe-2">
       <i class="bi bi-pencil"></i>
     </span>
