...
<button type="button" class="btn btn-primary btn-sm m-1" id="trackButton" data-toggle="modal" data-target="#maps">
    <i class="bi bi-geo"></i> View Maps
</button>
...
<div class="modal" id="maps">
    <div id="mapswider" class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Map Navigation</h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">
                <form id="driversDelete" action="driversdelete.php" method="post">
