        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input name="ItemImage" type="file" class="form-control" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label id="FinderPhone" for="FinderPhone">Finder Phone</label>
                    <input name="FinderPhone" type="text" class="form-control" required>
                </div>
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <label id="FoundLocation" for="FoundLocation">Found Location</label>
                    <input name="FoundLocation" type="text" class="form-control" required>
                </div>
                <div class="form-group">
                    <label id="FoundDate" for="FoundDate">Found Date</label>
                    <input name="FoundDate" type="date" class="form-control" required>
                </div>
                <div class="form-group">
                    <label id="FinderPerson" for="FinderPerson">Finder Person</label>
                    <input name="FinderPerson" type="text" class="form-control" required>
                </div>
                <div class="form-group">
                    <label id="FinderEmail" for="FinderEmail">Finder Email</label>
                    <input name="FinderEmail" type="text" class="form-control" required>
                </div>
            </div>
        </div>
    </div>
...
<div class="modal-footer">
                    ...
                    <button id="Register" type="button"  class="btn btn-success"><i class="fas fa-save"></i> Save</button>
                </div>
