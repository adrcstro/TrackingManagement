...
<script>
    ...
    <div class="map-container">
     ...
     <div class="File-table card shadow border-0 mb-7 d-flex justify-content-center align-items-center" style="display:none;" id="File-table">
    <div class="card-header thead-light text-center">
        <h5 class="mb-0" id="file" >File Complain for Unprofessional Public Service</h5>
    </div>

    <div class="flex-container">
        <div class="table-responsive">
            <div class="row mx-auto justify-content-center"> <!-- Center the row horizontally -->
