...
?>
<script> 
// Assuming you have included SweetAlert library in your HTML file

// Your AJAX call or any other method for handling the PHP response
// Example JavaScript code to handle the response
// Assuming you are using jQuery for AJAX

$.ajax({
    // your AJAX configurations here
