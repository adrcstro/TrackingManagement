...
<div class="modal fade" id="Drivertrack">
    ...
    <div class="row justify-content-center">
        <div class="col-2">
            <button type="button" class="btn btn-outline-secondary btn-block btn-sm m-1 custom-rating-button" data-toggle="modal" data-target="#rate1Star">
                <i class="bi bi-star"></i> Poor
            </button>
        </div>

        <div class="col-2">
            <button type="button" class="btn btn-outline-secondary btn-block btn-sm m-1 custom-rating-button" data-toggle="modal"  data-target="#rate2Stars">
                <i class="bi bi-star"></i> Fair
            </button>
        </div>

        <div class="col-2">
            <button type="button" class="btn btn-outline-secondary btn-block btn-sm m-1 custom-rating-button" data-toggle="modal" data-target="#rate3Stars">
                <i class="bi bi-star"></i> Good
            </button>
        </div>

        <div class="col-2">
            <button type="button" class="btn btn-outline-secondary btn-block btn-sm m-1 custom-rating-button" data-toggle="modal" data-target="#rate4Stars">
                <i class="bi bi-star"></i> Very Good
            </button>
        </div>

        <div class="col-2">
            <button type="button" class="btn btn-outline-secondary btn-block btn-sm m-1 custom-rating-button" data-toggle="modal" data-target="#rate5Stars">
                <i class="bi bi-star"></i> Excellent
            </button>
        </div>
    </div>
</div>
