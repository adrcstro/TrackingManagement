...
if (isset($_GET['username'])) {
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<label for='fileInput' class='btn btn-success' style='height: 40px; width: 150px; display: flex; align-items: center; justify-content: center;' data-toggle='modal' data-target='#passengerdelete'>
                    <span style='margin-right: 5px;'>Add Image</span>
                    <i class='fa fa-plus'></i>
                    <button type='button' id='fileInput' style='position: absolute; clip: rect(0, 0, 0, 0);'>
                        Choose File
                    </button>
                  </label>";
            echo "</div>";
