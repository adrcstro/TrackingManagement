...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT ComplaintID, TypeofComplaint, DateofReport, ComplainantName, ContactNumber, Address, NameofComplainee , ProfofIdentity FROM complainttbl WHERE ComplaintID = '$searchID'";
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            $letterContent .= "Please provide the incident description here.\n\n";
            ...
            $pdf->Cell(50, 10, 'Table Data 1', 1, 0, 'C');
            // First row, second column without color (width: 70)
            $pdf->Cell(140, 50, 'Table Data 2', 1, 1, 'C');
