...
<div class="modal fade" id="DriversRatings">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
...
<script>
  document.addEventListener("DOMContentLoaded", function() {
    // Check if the modal should be displayed based on two conditions
    // 1. Whether the modal should open on page load
    // 2. Whether the "Open Modal" button was clicked
    if (shouldOpenModalOnLoad() && localStorage.getItem("driversRatingsModalOpened")) {
      openModal();
    }
  });

  function shouldOpenModalOnLoad() {
    // Add your condition here, for example, check if a file is opened
    // If the condition is met, return true; otherwise, return false
    // Example: return fileIsOpened;
    return false; // Change this line based on your condition
  }
  ...
  function openModal() {
    ...
    localStorage.setItem("driversRatingsModalOpened", "true");

    // Disable the default behavior of the close button when the modal is opened
