...
<main>
    ...
    <ul class="dropdown-menu">
        <li name="usertype" id="usertype"><a class="dropdown-item" href="#" onclick="changeLoginType('Passenger')">Passenger</a></li>
        <li name="usertype" id="usertype"><a class="dropdown-item" href="#" onclick="changeLoginType('Driver')">Driver</a></li>
        <li name="usertype" id="usertype"><a class="dropdown-item" href="#" onclick="changeLoginType('Admin')">Admin</a></li>
    </ul>
</div>
<script>
