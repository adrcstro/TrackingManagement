...
<div class="modal" id="modal-container">
    <div id="modal-content">
      ...
      <div class="container">
        <div class="row  mt-4">
            <div class="col-md-6">
                <h1 class="text-center mt-4" style="font-size: 30px;" >Drivers Personal Rating Scale</h1>
    ...
    <?php
        ...
        if ($result) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<div class="carddriver  mt-1">';
                echo '<div style="position: relative; margin-top: -2rem;    ">'; // Add a relative position for proper stacking context
