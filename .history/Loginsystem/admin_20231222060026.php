...
<script>
  $(document).ready(function() {
    $("#DriversRegister").click(function(e) {
      ...
      $.ajax({
        url: "driverupdate.php", // Replace with the actual file name for update
        type: "POST",
        data: formData,
        processData: false,
        contentType: false,
...
<script>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <!-- Modal Body -->
                <div class="modal-body">
                <form id="updateForm" action="passenup.php"  method="post">
...
<div class="modal-footer">
  ...
  $(document).ready(function() {
    $("#PassengerRegister").click(function() {
      ...
      $.post(
        "passenup.php", // Replace with the actual file name for update
        {
