...
?>
    ...
    <button type="button" class="btn btn-warning btn-sm m-1" data-toggle="modaln" data-target="#update" id="updateButton">
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['input1']) && isset($_POST['input2']) && isset($_POST['datePicker']) && isset($_POST['input3'])) {
    // Create connection
    $conn = new mysqli($servername, $username, $password, $dbname);
...
if ($_SERVER["REQUEST_METHOD"] == "POSTS") {
    ...
    $updated_admin = $_POST['input1']; // Assuming the selected admin value is coming from input1
