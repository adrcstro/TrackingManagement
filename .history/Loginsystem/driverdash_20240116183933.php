...
if (isset($_GET['username'])) {
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<div class='image-box border rounded-circle p-3' style='display: inline-block; overflow: hidden;'>";
            echo '<img src="uploads/' . htmlspecialchars($row["Profile"]) . '" class="img-fluid mb-5 mt-2" style="width: 100px; height: 100px; border-radius: 50%;">'; // Adjust the width and height as needed
            echo "</div>";
            echo "</div>";
            echo "</div>";
