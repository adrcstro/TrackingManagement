...
<script>
    ...
    <div id="processreport" class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="PassengerDelete" action="itemsdelete.php" method="post">
                    <div class="form-group">
                        <label for="processreport">Select Report</label>
                        <select name="processreport" id="processreport" class="form-control" required>
                            <option value="" disabled selected>Select an option</option>
                            <?php
...
<div class="col-xl-3 col-sm-6 col-12">
    <div class="card shadow border-2">
        <div class="card-body">
            ...
            <button type="button" class="btn d-inline-flex btn-sm btn-neutral border-base mx-1" title="Process Passenger's Complaint about the tricycle service, the local transportation authority ">
...
<div class="col-xl-3 col-sm-6 col-12">
    <div class="card shadow border-2">
        <div class="card-body">
            ...
            <div class="mt-2 mb-0 text-sm text-center">
            <button type="button" class="btn d-inline-flex btn-sm btn-neutral border-base mx-1" title="The barangay officials diligently coordinated the schedules of the two parties involved, ensuring a mutually convenient time for them to meet and discuss the  issue.">
    <i class="bi bi-arrow-up me-1"></i>Select
</button>
            </div>
        </div>
...
<div class="col-xl-3 col-sm-6 col-12">
    <div class="card shadow border-2">
        <div class="card-body">
            ...
            <div class="mt-2 mb-0 text-sm text-center">
            <button  type="button" class="btn d-inline-flex btn-sm btn-neutral border-base mx-1" title="After thorough investigation and mediation, the barangay council officially declared the tricycle complaint case closed, having successfully resolved the concerns raised by the passenger. " onclick="updateRating('Delivered')">
    <i class="bi bi-arrow-up me-1"></i>Select
</button>
            </div>
        </div>
...
<div style="width: 80%; margin: auto; display:block;  margin-bottom: 10px;">
    ...
    <input class="form-control mx-auto" name="newStatus" id="newStatus" style="width: 100%;">
</div>
    ...
    function updateRating(rating) {
        ...
        // You can customize this value as per your requirement
                    ...
                    <div class="modal-footer mt-3  d-flex justify-content-center ">
                        ...
                        <button id="ReportDelete" type="submit" class="btn btn-success mt-3">Mark Status</button>
                    </div>
                </form>
            </div>
        </div>
