...
<div class="modal" id="Driverdelete">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="driversrDelete" action="driversdelete.php" method="post">
                    <div class="form-group">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        <button id="DriversDelete" type="submit" class="btn btn-danger">Delete</button>
                    </div>
                </form>
            </div>
        </div>
...
<script>
    $(document).ready(function() {
        $('#DriversDelete').submit(function(e) {
            e.preventDefault();
            var formData = $(this).serialize();
            $.ajax({
                type: 'POST',
                url: 'driversdelete.php',
                data: formData,
                dataType: 'json',
