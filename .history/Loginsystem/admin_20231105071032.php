        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h4 class="modal-title">Create Adminstrator Information</h4>
                ...
                <div class="modal-body">
                    <form action="admin.php">
                        ...
                        <div class="form-group">
                            ...
                            <input name="input3" type="text" class="form-control" >
                        </div>
                    </form>
                </div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Make sure to handle the database connection properly and prevent SQL injection

    // Sample query (replace with your own)
    $sql = "UPDATE admintbl SET Username='$username', DateCreated='$date', Password='$password' WHERE Admin='$admin'";
...
// Sample query to fetch Admin data (replace with your own)
$adminData = array(); // Replace this array with fetched data

// Sample data for demonstration purposes
$adminData = array("Admin1", "Admin2", "Admin3", "Admin4");
?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="updateForm">
                    <div class="form-group">
                        <label for="adminDropdown">Select BRGY-Admin</label>
                        <select name="admin" id="adminDropdown" class="form-control">
                            <?php
                    ...
                    <div class="form-group">
                        <label for="input2">Update Username</label>
                        <input type="text" name="username" id="input2" class="form-control">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="input3">Update Password</label>
                        <input name="password" id="input3" type="text" class="form-control">
                    </div>
                </form>
            </div>
            <!-- Modal Footer -->
...
<script>
    $(document).ready(function () {
        $("#saveButton").click(function () {
            var adminValue = $("#adminDropdown").val();
            var usernameValue = $("#input2").val();
            var dateValue = $("#datePicker").val();
            var passwordValue = $("#input3").val();

            $.ajax({
                type: "POST",
                url: "admin.php", // Replace with the correct PHP file that handles the update operation
                data: {
                    admin: adminValue,
