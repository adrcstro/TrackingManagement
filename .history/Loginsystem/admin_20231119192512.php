         ...
         <li class="nav-item">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="#" onclick="showNews()">Create</a></li>
...
<div class="modal fade" id="Drivertrack">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <button type="button" class="btn btn-primary btn-sm m-1" id="trackButton" data-target="#mapModal" data-toggle="modal">
...
<button type="button" class="btn btn-warning btn-sm m-1" id="warningButton" data-toggle="modal">
    <i class="fas fa-exclamation-triangle"></i> Issue a Warning
</button>
...
<div  id="createnews" style="display:none;" class="card shadow border-0 mb-7">
                    ...
                    <div class="card-footer border-0 py-3 d-flex justify-content-center flex-wrap">
                    <button type="button" class="btn btn-primary btn-sm m-1" data-toggle="modal" data-target="#createnews">
    <i class="bi bi-arrow-up"></i> Create
</button>

<<button type="button" class="btn btn-primary btn-sm m-1" data-toggle="modal" data-target="#createnews" onclick="changeButton('create')">
    <i class="bi bi-arrow-up"></i> Create
</button>

<button type="button" class="btn btn-danger btn-sm m-1" data-toggle="modal" data-target="#editnews" onclick="changeButton('edit')">
    <i class="bi bi-trash"></i> Edit
</button>

<button type="button" class="btn btn-secondary btn-sm m-1" data-toggle="modal" data-target="#deletenews" onclick="changeButton('delete')">
    <i class="bi bi-file-text"></i> Delete
</button>

<button type="button" class="btn btn-info btn-sm m-1" id="refreshButton4" onclick="changeButton('refresh')">
    <i class="bi bi-arrow-clockwise"></i> Refresh
</button>

<script>
function changeButton(action) {
    var button = document.querySelector('[onclick="changeButton(\'' + action + '\')"]');
    ...
    switch (action) {
        case 'create':
            ...
            icon.classList.remove('bi-trash', 'bi-file-text', 'bi-arrow-clockwise');
            icon.classList.add('bi-arrow-up');
            break;
        case 'edit':
            button.classList.remove('btn-primary', 'btn-secondary', 'btn-info');
            button.classList.add('btn-danger');
            icon.classList.remove('bi-arrow-up', 'bi-file-text', 'bi-arrow-clockwise');
            icon.classList.add('bi-trash');
            break;
        case 'delete':
            button.classList.remove('btn-primary', 'btn-danger', 'btn-info');
            button.classList.add('btn-secondary');
            icon.classList.remove('bi-arrow-up', 'bi-trash', 'bi-arrow-clockwise');
            icon.classList.add('bi-file-text');
            break;
        case 'refresh':
            button.classList.remove('btn-primary', 'btn-danger', 'btn-secondary');
            button.classList.add('btn-info');
            icon.classList.remove('bi-arrow-up', 'bi-trash', 'bi-file-text');
