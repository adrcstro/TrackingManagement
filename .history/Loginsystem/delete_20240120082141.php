...
$selectedreport = isset($_POST['Selectreport']) ? $_POST['Selectreport'] : null;
    ...
    if ($conn->connect_error) {
        ...
        if ($conn->query($adminSql) === TRUE && $conn->query($driverSql) === TRUE && $conn->query($passengerSql) === TRUE && $conn->query($LostitemSql) === TRUE && $conn->query($Founditemsql) === TRUE && $conn->query($reportSql) === TRUE) {
