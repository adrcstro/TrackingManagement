...
<div class="modal-footer">
    ...
    $query = "SELECT columnAdmin FROM admintbl";
    $result = mysqli_query($connection, $query); // $connection is your database connection

    while ($row = mysqli_fetch_array($result)) {
        echo "<option value='" . $row['columnAdmin'] . "'>" . $row['columnAdmin'] . "</option>";
    }
    ?>
</select>
    </div>
