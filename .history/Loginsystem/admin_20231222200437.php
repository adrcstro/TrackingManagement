    ...
    <?php
        ...
        if ($result) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<p class="card-text">' . $trimmed_body . ' <a href="#" class="read-more" style="display: block; margin: 10px auto; text-align: center; background-color: #603ce6; color: #fff; padding: 8px 16px; border-radius: 4px;" data-toggle="modal" data-target="#readMoreModal' . $row['NewsID'] . '">Read More</a></p>';
                echo '</div>';
                echo '</div>';
                echo '</div>';
