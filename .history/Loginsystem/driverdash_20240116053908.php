...
if (isset($_GET['username'])) {
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo "</div>";
            echo '<div class="col-md-6">';
            echo '<h2 class="mt-7 text-center" id="FAQ">Driver Personal Information</h2>';
            ...
            echo "</div>";
            echo "<div class='mb-3'>";
            echo "<input type='password' id='password' value='" . htmlspecialchars($row["Password"]) . "' class='form-control' readonly>";
            echo "<span id='togglePassword' class='eye-icon' onclick='togglePassword()'>👁️</span>";
            echo "</div>";
