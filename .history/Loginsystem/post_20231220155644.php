        ...
        if ($stmt->execute()) {
            ...
            echo '<script type="text/javascript">
                    swal("Success!", "Your item has been posted successfully.", "success").then(function() {
                        window.location = "admin.php"; // Redirect to another page if needed
                    });
                  </script>';
        } else {
            // Display error message using SweetAlert
            echo '<script type="text/javascript">
                    swal("Error!", "There was an error posting your item. Please try again.", "error");
                  </script>';
        }
    } else {
        // Display error message using SweetAlert
        echo '<script type="text/javascript">
                swal("Error!", "Item image not found in the uploaded files.", "error");
              </script>';
    }
}
