    ...
    $(function(){
        $('#SaveItem').click(function(e){
            ...
            if(valid){
                ...
                console.log('Form Data:', formData);  // Check if form data is as expected
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        console.log('AJAX Success:', data);  // Check AJAX success response
                        swal("Success", data, "success").then((value) => {
                            if (value) {
                                // Optionally, you can perform additional actions on success
                                // For example, display a message, update UI, etc.
                            }
                        });
                    },
                    error: function(xhr, status, error){
                        console.error('AJAX Error:', status, error);  // Check AJAX error response
