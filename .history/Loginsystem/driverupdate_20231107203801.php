...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $driversDriversLicense = $_FILES['DriversDriversLicense'];
    $driversVehicleRegistration = $_FILES['DriverVehicleRegistration'];
    $driversPermittoOperate = $_FILES['DriversPermittoOperate'];
