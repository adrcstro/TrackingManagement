...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            $letterContent = str_pad("BLOTTER REPORT", 100 + strlen("BLOTTER REPORT") / 2, " ", STR_PAD_LEFT) . "\n\n";
            $dateOfReport = "Date of Report: " . $row['DateofReport'];
            $letterContent .= str_pad($dateOfReport, 175, " ", STR_PAD_LEFT) . "\n\n";
