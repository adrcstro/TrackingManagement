...
if (isset($_GET['search'])) {
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            $imageType = "image/jpg"; // Change this based on your actual image type (jpeg, png, etc.)
    
            echo '<p>Vehicle Picture: <img src="data:' . $imageType . ';base64,' . base64_encode($imageData) . '" alt="PermittoOperate Image" style="width: 300px;"></p>';
      }
    } else {
