      ...
      <div class="box">
        <div class="inner-box">
          <div class="forms-wrap">
            <form id="clear" action="process.php" autocomplete="off" method="post" class="sign-in-form"   >
...
<div class="formsignin">
            ...
            <form action="process.php" method="post" autocomplete="off" class="sign-up-form">
