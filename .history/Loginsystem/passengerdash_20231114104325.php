...
<div class="modal" id="FileReport">
    ...
    <label id="input1" for="input1">Select Complaint Type</label>
    <select name="input1" class="form-control" required>
        <option value="" selected disabled>Choose Unprofessional Public Service that you Experience</option>
        <option value="john">John</option>
        <option value="mary">Mary</option>
        <option value="jane">Jane</option>
        <!-- Add more options as needed -->s
    </select>
</div>
    <div class="form-group">
