...
<button type="button" class="btn btn-secondary btn-sm m-1" data-toggle="modal"  onclick="openModal()" data-target="#RatingModal">
...
<script>
  ...
  function closeModal() {
    document.getElementById("RatingModall").style.display = "none";
