...
if(isset($_POST['PlateNumber'], $_POST['DriversLicense'], $_POST['VehicleRegistration'], $_POST['PermittoOperate'], $_POST['PhoneNumber'], $_POST['HomeAddress'])){
    ...
    $DriversLicense = sha1(file_get_contents($_FILES['DriversLicense']['tmp_name']));
    $VehicleRegistration = sha1(file_get_contents($_FILES['VehicleRegistration']['tmp_name']));
    $PermittoOperate = sha1(file_get_contents($_FILES['PermittoOperate']['tmp_name']));
