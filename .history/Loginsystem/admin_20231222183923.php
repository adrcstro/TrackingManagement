    ...
    <?php
        ...
        if ($result) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<div class="col-md-4 mb-4">'; // Adjusted margin-bottom to mb-4
                echo '<div class="card">';
                echo '<img src="uploads/' . $image . '" class="card-img-top" alt="Card Image">';
                echo '<div class="card-body">';
                echo '<h5 class="card-title">' . $header . '</h5>';
                echo '<p class="card-text mt-1 mb-2"><small class="text-muted">' . $time . ' | ' . $date . '</small></p>'; // Adjusted to mt-1 and mb-2 for top and bottom margin
