...
echo '<p><input type="text" value="Drivers License: ' . $row["DriversLicense"] . '" readonly style="border: 1px solid #ccc; padding: 5px; margin-bottom: 10px; border-radius: 5px; width: 300px;">';
echo '<button style="position: absolute; right: 5px; top: 5px;"><i class="fas fa-eye"></i> VIEW</button></p>';
echo '</div>';
echo '<div style="position: relative;">';
echo '<p><input type="text" value="Vehicle Registration: ' . $row["VehicleRegistration"] . '" readonly style="border: 1px solid #ccc; padding: 5px; margin-bottom: 10px; border-radius: 5px; width: 300px;">';
echo '<button style="position: absolute; right: 5px; top: 5px;"><i class="fas fa-eye"></i> VIEW</button></p>';
echo '</div>';
// Add similar buttons for other fields as needed
echo '</div>';
