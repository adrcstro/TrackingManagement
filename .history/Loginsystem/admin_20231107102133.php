...
<script>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <label for="SelectPassenger">Select Driver Infomation</label>
    ...
    <div class="form-group">
        <label id="PassengerGender" for="PassengerGender">Plate Number</label>
        <input name="PassengerGender" type="text" class="form-control" required>
    </div>
    <div class="form-group">
        <label id="PassengerPhone" for="PassengerPhone">Drivers License</label>
        <input type="file" name="PassengerPhone" class="form-control" required>
    </div>
    <div class="form-group">
        <label id="PassengerAddress" for="PassengerAddress">Vehicle Registration</label>
        <input type="file" name="PassengerAddress" class="form-control" required>
    </div>
    <div class="form-group">
        <label id="PassengerEmail" for="PassengerEmail">Permit to Operate</label>
        <input type="file" name="PassengerEmail" class="form-control" required>
    </div>
    <div class="form-group">
        <label id="PassengerEmail" for="PassengerEmail">Phone Number</label>
        <input type="text" name="PassengerEmail" class="form-control" required>
    </div>
    <div class="form-group">
        <label id="PassengerEmail" for="PassengerEmail">Home Address</label>
        <input type="text" name="PassengerEmail" class="form-control" required>
    </div>
