...
<script>
        ...
        <div class="modal-dialog" id="lostandfound"  >
            <div class="modal-content">
                ...
                <!-- Modal Body -->
                <div class="modal-body">
                <form action="passengerdash.php" method="post" enctype="multipart/form-data">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
            ...
            $.ajax({
                ...
                success: function (data) {
                    swal("Success", data, "success").then((value) => {
                        if (value) {
                            // Optionally, you can reload or perform other actions on success
                            window.location.reload(); // Reload the page
                        }
                    });
                },
                error: function (xhr, status, error) {
                    swal("Error", "There were errors while saving the data. " + error, "error");
                }
            });
