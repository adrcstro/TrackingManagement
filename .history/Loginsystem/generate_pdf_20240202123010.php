...
class PDF extends TCPDF {
    ...
    public function Header() {
        ...
        // Apply blur effect
        imagefilter($watermark, IMG_FILTER_GAUSSIAN_BLUR);
        
        // Position and size of the watermark image
        $this->Image($watermark, 30, 50, 150, 150, '', '', '', false, 300, '', false, false, 0, 'Multiply');
        
        // Destroy the watermark image to free up memory
