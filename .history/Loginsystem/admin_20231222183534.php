...
echo '<div class="card-body">'; // Removed inline style
echo '<h5 class="card-title">' . $header . '</h5>';
echo '<p class="card-text small-margin"><small class="text-muted">' . $time . ' | ' . $date . '</small></p>'; // Added custom class
$trimmed_body = strlen($body) > 90 ? substr($body, 0, 90) . '...' : $body;
echo '<p class="card-text small-margin">' . $trimmed_body . ' <a href="#" class="read-more" data-toggle="modal" data-target="#readMoreModal' . $row['NewsID'] . '">Read More</a></p>';
echo '</div>';
echo '</div>';
echo '</div>';
