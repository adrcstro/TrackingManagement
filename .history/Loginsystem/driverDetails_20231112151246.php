...
echo '<a href="view-details.php?type=license&id=' . urlencode($row["DriversLicense"]) . '" target="_blank" class="btn btn-outline-secondary transparent-btn" type="button">View License <i class="fas fa-eye"></i></a>';
echo '</div>';
echo '</div>';
...
echo '<div class="input-group-append">';
echo '<a href="view-details.php?type=registration&id=' . urlencode($row["VehicleRegistration"]) . '" target="_blank" class="btn btn-outline-secondary transparent-btn" type="button">View Registration <i class="fas fa-eye"></i></a>';
echo '</div>';
echo '</div>';
