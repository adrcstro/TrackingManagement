...
echo '<span class="input-group-text"><i class="fas fa-id-card"> value="' . $row["DriversLicense"] .'"';
echo '</div>';
...
echo '<div class="input-group mb-3">';
echo '<div class="input-group-prepend">';
echo '<span class="input-group-text"><i class="fas fa-car"></i> ' . $row["VehicleRegistration"] . '</span>';
echo '</div>';
