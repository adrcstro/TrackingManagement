...
?>            
                    ...
                    <div class="card-footer border-0 py-3 d-flex justify-content-center flex-wrap">
                    <button type="button" class="btn btn-success btn-sm m-1" data-toggle="modal" data-target="#createnews" style="transition: opacity 0.3s ease-in-out;">
    <i class="bi bi-plus" style="transition: opacity 0.3s ease-in-out;"></i> Create
</button>

<button type="button" class="btn btn-warning btn-sm m-1" data-toggle="modal" data-target="#editnews" style="transition: opacity 0.3s ease-in-out;">
    <i class="bi bi-pencil" style="transition: opacity 0.3s ease-in-out;"></i> Edit
</button>

<button type="button" class="btn btn-danger btn-sm m-1" data-toggle="modal" data-target="#deletenews" style="transition: opacity 0.3s ease-in-out;">
    <i class="bi bi-trash" style="transition: opacity 0.3s ease-in-out;"></i> Delete
</button>

<button type="button" class="btn btn-primary btn-sm m-1" id="refreshButton4" style="transition: opacity 0.3s ease-in-out;">
    <i class="bi bi-arrow-clockwise" style="transition: opacity 0.3s ease-in-out;"></i> Refresh
</button>
...
<script>
    ...
    <div class="form-group">
        <label id="newsneader" for="input1">Header</label>
    ...
    <div class="form-group">
        ...
        <input name="bodycontent" type="text" class="form-control" required>
    </div>
    <div class="form-group">
