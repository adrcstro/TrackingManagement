...
echo ' <input type="text" value="Driver Name: ' . $username . '" class="form-control" data-username="' . $username . '" id="usernameInput" aria-describedby="button-addon2">';
...
function copyUsername() {
    ...
    var username = usernameInput.getAttribute("data-username");

    // Create a temporary textarea element to facilitate copying
    var tempTextarea = document.createElement("textarea");

    // Set the value of the temporary textarea to the username
...
// Add an event listener to the button to call the copyUsername function
document.getElementById("button-addon2").addEventListener("click", copyUsername);
</script>
