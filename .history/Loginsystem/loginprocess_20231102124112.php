...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT * FROM admintbl,driverstvl,passengertbl WHERE $column2 = '$Username' AND $column3 = '$Password' $column7 = '$Username' AND $column8 = '$Password' $column2 = '$Username' AND $column4 = '$Password'                                                     ";
