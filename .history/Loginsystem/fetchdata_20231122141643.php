    ...
    <?php
        ...
        if ($result) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<h6 class="card-title">Vehicle Number: <span style="font-weight:normal;">' . $phone . '</span></h6>';
                echo '<h6 class="card-title">Plate Number: <span style="font-weight:normal;">' . $home . '</span></h6>';
