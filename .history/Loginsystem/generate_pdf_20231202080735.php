...
// New cell in a new column
// Original cell with increased height
$pdf->Cell(100, 20, "New Information: ", 1, 0, 'C'); // Note the change in the last parameter from 1 to 0

// Move to the next line without creating extra space
$pdf->SetXY($pdf->GetX(), $pdf->GetY() - 10); // Adjust the value (-10) based on the original height
