            ...
            legend: {
                ...
                labels: {
                    generateLabels: function(chart) {
                        return [
                            { text: '1=Very Poor', fillStyle: '#603ce6' },
                            { text: '2=Poor', fillStyle: '#603ce6' },
                            { text: '3=Fair', fillStyle: '#603ce6' },
                            { text: '4=Good', fillStyle: '#603ce6' },
                            { text: '5=Excellent', fillStyle: '#603ce6' }
                        ];
                    }
                }
            }
