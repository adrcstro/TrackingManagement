...
<div class="d-flex flex-column flex-lg-row h-lg-full bg-surface-secondary">
    ...
    <a class="nav-link" href="#" onclick="showDriver()">
        <i class="fas fa-chart-line"></i> Drivers Rating Scale
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#" onclick="showcomplainabotyou()" >
                        <i class="bi bi-card-heading"></i> Complain About You
                        </a>
                    </li>
...
<div class="container">
        ...
        <div class="table-responsive">
            <div class="calculator" style="flex: 1; padding-right: 20px;">
                ...
                <div class="card-footer border-0 py-3 d-grid gap-1 d-md-flex justify-content-md-center mt-4">
                    ...
                    <button id="calculatorbutton" class="btn btn-danger btn-sm w-100" onclick="resetInputs()">
  ...
  <div class="row d-flex justify-content-center align-items-center">
    ...
    <div class="row justify-content-center">
        <div class="col-md-4 mb-4">
            <div id="cards" class="card">
                <img src="../images/h4.jpg" class="card-img-top img-fluid" alt="...">
                <div class="card-body">
    ...
    <a href="#" class="btn btn-primary btn-sm mt-2" data-toggle="modal" data-target="#FileReport">
        ...
        <div class="col-md-4 mb-4">
            <div id="cards" class="card">
                <img src="../images/Overcharging.jpg" class="card-img-top img-fluid" alt="...">
                <div class="card-body">
...
<div class="calculator-table card shadow border-0 mb-7" style="display:none;" id="drivercomplainaboutyou">
    <div class="card-header thead-light text-center">
        <h5 class="mb-0" id="calculator" >Driver Complain About your Behaviour</h5>
    </div>
...
$sql = "SELECT * FROM complainttbl WHERE NameofComplainee = (SELECT Name FROM passengertbl WHERE Username = ?)";
...
<div class="calculator-table card shadow border-0 mb-7" style="display:none;" id="drivercomplaintopasschedule">
    <div class="card-header thead-light text-center">
...
if ($result->num_rows > 0) {
    ...
    echo "You dont have any Schedulled Complains Keep it Up";
}
...
<div class="card-footer border-0 py-3 d-grid gap-2 d-md-flex justify-content-md-center">
                    <button type="button" class="btn btn-success btn-sm w-100 mb-2" data-toggle="modal" data-target="#drivercomplainabtpassengerconfirm">
                    <i class="bi bi-check-circle"></i> Confirm to Attend
</button>
...
<div class="modal fade" id="drivercomplainabtpassengerconfirm">
    <div id="processreport" class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Confirm Appointment?</h4>
            ...
            <div class="modal-body">
                <form id="updateForm"  method="post">
                    <div class="form-group">
                        <label for="driverconpassconfirm">Select Report</label>
                        <select name="driverconpassconfirm" id="driverconpassconfirm" class="form-control" required>
                            <option value="" disabled selected>Select an option</option>
    ...
    <div class="col-xl-3 col-sm-6 col-12">
      <div class="card shadow border-2 text-center">
        <div class="card-body" style="padding: 20px;">
          ...
          <div class="text-sm">
            <button type="button" class="btn btn-sm btn-neutral border-base" title="Process Passenger's Complaint about the tricycle service, the local transportation authority " onclick="updatecomtopassstatu('Confirmed')">
              <i class="bi bi-arrow-up me-1"></i>Select
            </button>
          </div>
        </div>
    ...
    <div class="col-xl-3 col-sm-6 col-12">
      <div class="card shadow border-2 text-center">
        <div class="card-body" style="padding: 20px;">
          ...
          <div class="text-sm">
            <button type="button" class="btn btn-sm btn-neutral border-base" title="Process Passenger's Complaint about the tricycle service, the local transportation authority " onclick="updatecomtopassstatu('Cancel Appointment')">
              <i class="bi bi-arrow-up me-1"></i>Select
            </button>
          </div>
        </div>
...
<div style="width: 80%; margin: auto; display:none;  margin-bottom: 10px;">
    <label for="drivercompassstatus"></label>
    <input class="form-control mx-auto" name="drivercompassstatus" id="drivercompassstatus" style="width: 100%;">
</div>

<script>
    function updatecomtopassstatu(rating) {
        document.getElementById("drivercompassstatus").value = rating + "";
        // You can customize this value as per your requirement
    }
</script>
                    ...
                    <div class="modal-footer   d-flex justify-content-center ">
                        ...
                        <button id="drivercompassbuttonappo" type="button" class="btn btn-success mt-3">
                        <i class="bi bi-check-circle-fill"></i> Confirm Appointment Status</button>
                    </div>
                </form>
            </div>
...
<script>
  $(document).ready(function() {
    $("#drivercompassbuttonappo").click(function() {
      var Confirmid = $("#driverconpassconfirm").val();
      var ConfirmStatus = $("input[name='drivercompassstatus']").val();
...
<div class="calculator-table card shadow border-0 mb-7" style="display:none;" id="drivertopasslistofsetteldcomp">
    <div class="card-header thead-light text-center">
...
<div class="card-footer border-0 py-3 d-grid gap-2 d-md-flex justify-content-md-center">
                    <button type="button" class="btn btn-danger btn-sm w-100 mb-2" data-toggle="modal" data-target="#drivercomtopassdelete">
    <i class="bi bi-trash"></i> Delete History
</button>
...
<div class="modal fade" id="drivercomtopassdelete">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Delete Report Details</h4>
            ...
            <div class="modal-body">
                <form id="reportdeletedrivertopasshistory" action="delete.php" method="post">
                    <div class="form-group">
                        <label for="Selectreport">Delete Selected Report </label>
                        <select name="Selectreport" id="Selectreport" class="form-control" required>
                            <option value="" disabled selected>Select an option</option>
...
<script>
        $(document).ready(function() {
            $('#reportdeletedrivertopasshistory').submit(function(e) {
                e.preventDefault();
                var formData = $(this).serialize();
                $.ajax({
                    type: 'POST',
