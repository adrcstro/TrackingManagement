...
<script>
    document.getElementById('printButton').addEventListener('click', function () {
        // Clone the form to preserve the original form
        var clonedForm = document.getElementById('complaintform').cloneNode(true);

        // Create a data URL for the cloned form
        var formBlob = new Blob([clonedForm.outerHTML], { type: 'text/html' });
        var formURL = URL.createObjectURL(formBlob);
