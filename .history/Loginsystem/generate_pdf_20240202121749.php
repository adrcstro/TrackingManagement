...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            $letterContent = str_pad("<span style='text-shadow: 2px 2px 4px #000;'>BLOTTER REPORT</span>", 80 + strlen("BLOTTER REPORT") / 2, " ", STR_PAD_LEFT) . "\n\n";
            $dateOfReport = "<span style='text-shadow: 2px 2px 4px #000;'>Date Filed: " . $row['DateofReport'] . "</span>";
            $letterContent .= str_pad($dateOfReport, 155, " ", STR_PAD_LEFT) . "\n\n";
            
            // Rest of your code...
            
            $letterContent .= "<span style='text-shadow: 2px 2px 4px #000;'>I am writing to formally bring to your attention a matter that requires your immediate Action. Complaint ID: " . $row['ComplaintID'] . ". This report pertains to a " . $row['TypeofComplaint'] . " that transpired on " . $row['DateofReport'] . ". The incident involves </span>";
            $letterContent .= "<span style='text-shadow: 2px 2px 4px #000;'>a complainant identified as " . $row['ComplainantName'] . ". The complainant, residing at " . $row['Address'] . " and reachable at " . $row['ContactNumber'] . ", reported an incident involving the complainee, " . $row['NameofComplainee'] . ".</span>\n\n";
            
            $letterContent .= "<span style='text-shadow: 2px 2px 4px #000;'>In providing a comprehensive account of the incident, the complainant details are as follows:</span>\n";
            $letterContent .= "<span style='text-shadow: 2px 2px 4px #000;'>Name: " . $row['ComplainantName'] . ". ";
            $letterContent .= "Contact Number: " . $row['ContactNumber'] . ". ";
            $letterContent .= "Address: " . $row['Address'] . ".</span>\n\n";
            
            $letterContent .= "<span style='text-shadow: 2px 2px 4px #000;'>I would like to furnish you with the following details: ";
            $letterContent .= $row['IncidentDescription'] . ". Subsequent to this, a diligent investigation has been conducted. Actions taken during the investigation include </span>";
            $letterContent .= "<span style='text-shadow: 2px 2px 4px #000;'>documenting statements, gathering evidence, and interviewing relevant parties. This report encapsulates the details of the complaint, our investigative efforts, and the actions taken thus far.</span>\n\n";
            
            $letterContent .= "<span style='text-shadow: 2px 2px 4px #000;'>We appreciate your prompt attention to this matter and anticipate your cooperation in resolving the issues presented herein. Thank you for your commitment to maintaining the integrity and safety within our community.</span>\n\n";
