...
echo ' <input id="copyInput"type="text" value="Driver Name: ' . $row["Username"] . '" class="form-control" aria-describedby="button-addon2">';
...
document.getElementById('button-addon2').addEventListener('click', function() {
  ...
  // Log a message to indicate that the text has been copied (you can customize this)
  console.log('Text has been copied to the clipboard:', inputElement.value);
});
</script>