...
<script>
    document.getElementById('trackButton').addEventListener('click', function () {
        ...
        var driverAge = document.getElementsByName('DriverAge')[0].value;
        var driverPlateNumber = document.getElementsByName('DriverPlanteNumber')[0].value;
        var driversLicense = document.getElementsByName('DriversDriversLicense')[0].files[0];
        var driverVehicleRegistration = document.getElementsByName('DriverVehicleRegistration')[0].files[0];
        var permitToOperate = document.getElementsByName('DriversPermittoOperate')[0].files[0];
        var phoneNumber = document.getElementsByName('DriversPhoneNumber')[0].value;
        var homeAddress = document.getElementsByName('DriversHomeAddress')[0].value;

        var formData = new FormData();
        formData.append('selectedDriver', selectedDriver);
        formData.append('driverAge', driverAge);
        formData.append('driverPlateNumber', driverPlateNumber);
        ...
        // Now you can send this formData object using AJAX to a PHP script that will handle the data.
        // Example:
