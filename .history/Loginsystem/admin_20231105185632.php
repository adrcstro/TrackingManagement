...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['input1']) && isset($_POST['input2']) && isset($_POST['datePicker']) && isset($_POST['input3'])) {
        ...
        $input3 = $_POST['input3'];
        insertData($conn, $input1, $input2, $datePicker, $input3);
    }
    ...
    if (isset($_POST['input1']) && isset($_POST['input2']) && isset($_POST['datePicker']) && isset($_POST['input3'])) {
        ...
        updateData($conn, $updated_admin, $updated_username, $updated_date, $updated_password);
    }
}

function insertData($conn, $input1, $input2, $datePicker, $input3)
{
...
function updateData($conn, $updated_admin, $updated_username, $updated_date, $updated_password)
{
