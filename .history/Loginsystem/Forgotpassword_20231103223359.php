...
if (isset($_POST['reset_password'])) {
    ...
    if ($newPassword !== $confirmNewPassword) {
        ...
        if ($success1 || $success2 || $success3) {
            echo "<script>swal('Success', 'Password reset successfully for at least one table', 'success');</script>";
        } else {
            echo "<script>swal('Error', 'Your Username is not Registered in Our System', 'error');</script>";
        }
    }
}
// ...
