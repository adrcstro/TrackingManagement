    ...
    <?php
        ...
        if ($result) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<p class="card-text">' . $trimmed_body . ' <a href="#" class="read-more-btn" data-toggle="modal" data-target="#readMoreModal' . $row['NewsID'] . '"><i class="fas fa-arrow-right"></i> Read More</a></p>';
