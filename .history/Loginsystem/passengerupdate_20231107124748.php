...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($SelectDriver)) {
        ...
        $stmtDriver->bind_param("sssssss", $DriverAge, $DriverPlanteNumber, $DriversDriversLicense, $DriverVehicleRegistration, $DriversPermittoOperate, $DriversPhoneNumber, $DriversHomeAddress, $SelectDriver);
