...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($usertype == 'admin') {
        ...
        $column_name = "Email" && "Password"; // Replace with the actual column name
    }

    $sql = "SELECT $column_name FROM $table_name WHERE username = '$username' AND password = '$password' && Name = '$Name' AND PlateNumber = '$PlateNumber' ";
