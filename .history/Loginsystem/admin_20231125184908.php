        ...
        $.ajax({
          ...
          success: function(response) {
            if (response.status === 'success') {
              // Include the alert.php script
              $.getScript('admincrud.php', function() {
...
echo '<i class="fas fa-map-marker location-icon" onclick="copyToClipboard(\'driverName' . $row['id'] . '\')"></i>';
