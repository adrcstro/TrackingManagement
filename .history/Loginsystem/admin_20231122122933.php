...
?>            
                 ...
                 <button type="button" class="btn btn-warning btn-sm m-1 rounded-pill" data-toggle="modal" data-target="#Driverupdate">
    <i class="bi bi-pencil"></i> Update
</button>

<button type="button" class="btn btn-danger btn-sm m-1 rounded-pill" data-toggle="modal"  data-target="#Driverdelete">
    <i class="bi bi-trash"></i> Delete
</button>
<button type="button" class="btn btn-primary btn-sm m-1 rounded-pill" id="trackButton" data-toggle="modal" data-target="#Drivertrack">
    <i class="bi bi-geo"></i> Track
</button>
<button type="button" class="btn btn-info btn-sm m-1 rounded-pill" id="refreshButton3">
...
?>
                    ...
                    <button type="button" class="btn btn-success btn-sm m-1 rounded-pill" data-toggle="modal" data-target="#myModal" >
    <i class="bi bi-plus-circle"></i> Create
</button>


<button type="button" class="btn btn-warning btn-sm m-1 rounded-pill" data-toggle="modal" data-target="#update">
    <i class="bi bi-pencil"></i> Update
</button>

<button type="button" class="btn btn-danger btn-sm m-1 rounded-pill" data-toggle="modal"  data-target="#delete">
    <i class="bi bi-trash"></i> Delete
</button>

 <button type="button" class="btn btn-info btn-sm m-1 rounded-pill" id="refreshButton">
        <i class="bi bi-arrow-clockwise"></i> Refresh
    </button>
<script>
...
<div class="modal-footer">
                    <button type="button" class="btn btn-secondary btn-sm m-1 rounded-pill" data-dismiss="modal"> <i class="fas fa-times"></i> Close</button>
                    <button id="Register" type="button" class="btn btn-primary rounded-pill" ><i class="fas fa-check"></i> Save</button>
                </div>
