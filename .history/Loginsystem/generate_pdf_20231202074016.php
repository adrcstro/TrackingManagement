    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            if ($driverInfoResult->num_rows > 0) {
                ...
                $pdf->Cell(90, 10, 'Additional Information', 1, 1, 'C'); // Second cell in the first row
                
                // Additional cells with the original code
                $pdf->Cell(90, 10, "Vehicle Number: " . $driverInfo['Age'], 1, 0, 'C'); // First cell in the second row
