                    ...
                    <div class="row align-items-center">
                        <div class="col-sm-6 col-12 mb-4 mb-sm-0">
                            ...
                            <h1 class="h2 mb-0 ls-tight" id="title">
                                Plate-to-Place Tricycle Tracking Management Complain&Report Web-Application</h1>
                        </div>
                        <!-- Actions -->
...
<div class="modal" id="FileReport">
    ...
    <label id="Fileinput1" for="Fileinput1">Type of Complaint</label>
    <select name="Fileinput1" class="form-control" required>
...
<div class="form-group g-col-6 g-col-md-4">
        <label id="datefilereport" for="datefilereport">Select Date</label>
        <input name="datefilereport" type="date" class="form-control" required>
    </div>
    <div class="form-group g-col-6 g-col-md-4">
        <label id="Fileinput3" for="Fileinput3">Name of Complainant</label>
        <input name="Fileinput3" type="text" class="form-control" required>
    </div>
    <div class="form-group g-col-6 g-col-md-4">
        <label id="Fileinput4" for="Fileinput4">Contact Number</label>
        <input name="Fileinput4" type="text" class="form-control" required>
    </div>
    <div class="form-group g-col-6 g-col-md-4">
        <label id="Fileinput5" for="Fileinput5">Home Address</label>
        <input name="Fileinput5" type="text" class="form-control" required>
    </div>
    <div class="form-group g-col-6 g-col-md-4">
        <label id="Fileinput5" for="Fileinput5">Submit Any Prof To Identify Driver</label>
        <input name="Fileinput5" type="file" class="form-control" required>
    </div>

    <div class="form-group text-center">
    <label for="SearchDriver" class="col-12 col-md-4">Search for Driver Information</label>
    <input type="text" name="SearchDriver" id="SearchDriver" class="form-control col-12 col-md-8" placeholder="Name/VehicleNumber/PlateNumber" required>
</div>
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="form-group text-center">
                <label for="SearchDriver">Search for Driver Information</label>
                <input type="text" name="SearchDriver" id="SearchDriver" class="form-control" placeholder="Name/VehicleNumber/PlateNumber" required>
            </div>
        </div>
    </div>
</div>
...
<div class="modal-footer">
                    ...
                    <button id="filereportRegister" type="button" class="btn btn-primary">Submit</button>
                </div>
