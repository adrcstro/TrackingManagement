...
<div class="col-xl-3 col-sm-6 col-12">
    <div class="card shadow border-2 text-center">
        <div class="card-body" style="padding: 20px;"> <!-- Adjust padding for better spacing -->
            <div class="mb-2">
...
<div class="col-xl-3 col-sm-6 col-12">
    <div class="card shadow border-2 text-center">
        <div class="card-body" style="padding: 20px;"> <!-- Adjust padding for better spacing -->
            ...
            <div class="mb-3">
                <div class="icon icon-shape bg-transparent text-primary text-center">
                    <img src="../Images/Confirmed.svg" alt="Cancel" class="img-fluid" style="max-width: 200px; height: auto;">
                </div>
            </div>
            <div class="text-sm">
