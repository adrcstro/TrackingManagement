      ...
      <div class="box">
        <div class="inner-box">
          <div class="forms-wrap">
            <form id="clear" action="Driverlogin.php" method="post" autocomplete="off" class="sign-in-form" enctype="multipart/form-data"     >
...
<div class="formsignin">
  ...
  <input class="form-control" type="file" id="DriversLicense" name="DriversLicense" accept=".jpg, .png .jpeg .pdf, .doc, .docx" title="Please ensure the image is clear and legible" >
</div>

<div id="Filefield" class="input-wrap">
  <label for="VehicleRegistration" class="custom-label">Vehicle Registration</label>
  <input class="form-control" type="file" id="VehicleRegistration" name="VehicleRegistration" accept=".jpg, .png .jpeg .pdf, .doc, .docx" title="Please ensure the image is clear and legible" >
</div>
<div id="Filefield" class="input-wrap">
  <label for="PermittoOperate" class="custom-label">Permit to Operate</label>
  <input class="form-control" type="file" id="PermittoOperate" name="PermittoOperate" accept=".jpg, .png .jpeg .pdf, .doc, .docx" title="Please ensure the image is clear and legible" >
</div>
...
formData.append('PermittoOperate', PermittoOperate);
formData.append('PhoneNumber', PhoneNumber);
formData.append('HomeAddress', HomeAddress);
formData.append('file', fileInput.files[0]); // Add the file here
