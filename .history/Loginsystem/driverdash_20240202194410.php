...
<div class="modal" id="FileReport">
    ...
    <select name="Fileinput1" id="Fileinput1" class="form-control" required>
        ...
        <option value="overcharging">Disruptive Behavior/Masaman Asta o Paguugali</option>
        <option value="refusal_service">Refusing to Follow Driver's Instructions/Hindi Sumusunod sa Bilin ng Driver</option>
        <option value="reckless_driving">Verbal Abuse/Pagsasalita ng Masama</option>
        <option value="vehicle_condition">Failure to Pay Fare/Hindi PAgbabayad ng Kalkuladong Pamasahe</option>
