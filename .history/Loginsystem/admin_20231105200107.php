...
$(document).ready(function(){
    $("#Register").click(function(){
        ...
        $.post("admin.php",
        {
            insert: true, // Set a flag to indicate the insert operation
            input1: input1,
            input2: input2,
        ...
        function(data, status){
            // Check the response from the server for success or error message
            if (data.includes("successfully")) {
                ...
                Swal.fire({
                    title: 'Error!',
                    text: 'Error creating new record',
                    icon: 'error',
                    confirmButtonText: 'Okay',
                });
            }
...
$(document).ready(function(){
    $("#Update").click(function(){
        ...
        {
            update: true, // Set a flag to indicate the update operation
            input1: input1,
            input2: input2,
            datePicker: datePicker,
            input3: input3
