...
<script>
    function redirect() {
        ...
        window.open('https://www.google.com/maps/dir/Brgy.+409,+Sampaloc,+Manila,+1008+Metro+Manila//@14.6017717,120.9964639,471m/data=!3m1!1e3!4m8!4m7!1m5!1m1!1s0x3397c9fb6c83552d:0x54ad786f735dc69e!2m2!1d120.9973109!2d14.602139!1m0?entry=ttu', '_blank');
    }
</script>
...
<script>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                <form id="updateForm" action="admin.php"  method="post">
                <label for="SelectPassenger">Search Complain-ID</label>
                        <select name="SelectPassenger" id="SelectPassenger" class="form-control" required>
                            <option value="" disabled selected>Select an option</option>
                            <?php
    ...
    <div class="form-group">
        <label id="TYPEOFCOMPLAIN" for="TYPEOFCOMPLAIN">Type of Complain</label>
        <input type="text" name="TYPEOFCOMPLAIN" class="form-control" required>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <label id="PROFOFIDENTITY" for="PROFOFIDENTITY">Prof of Identity</label>
        <input type="file" name="PROFOFIDENTITY" class="form-control" required>
    </div>

    <div class="form-group">
        <label id="NAMEOFCOMPLAINEE" for="NAMEOFCOMPLAINEE">Name of Complainee</label>
        <input type="text" name="NAMEOFCOMPLAINEE" class="form-control" required>
    </div>
...
<div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <button id="PassengerRegister" type="button" class="btn btn-primary">Save Report</button>
                </div>
