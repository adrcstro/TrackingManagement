...
<div class="d-flex flex-column flex-lg-row h-lg-full bg-surface-secondary">
    ...
    <div class="card shadow border-0">
     ...
     <div   id="calculator-table" style="display:none;" class="card shadow border-0 mb-7">
...
<!--Calculator Start------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------->
    ...
    <label id="Labelcalculator" for="distance">Distance (in kilometers):</label>
    <input type="number" id="distance" placeholder="Enter distance" step="0.1">

    <label for="fareRate">Fare Rate (per kilometer):</label>
    <input id="Inputcalculator" type="number" id="fareRate" placeholder="Enter fare rate">

    <button id="Buttoncalculator" onclick="calculateFare()">Calculate Fare</button>
