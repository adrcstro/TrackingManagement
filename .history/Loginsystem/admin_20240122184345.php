...
<div class="col-xl-3 col-sm-6 col-12">
    <div class="card shadow border-2">
        <div class="card-body">
            ...
            <button type="button" class="btn d-inline-flex btn-sm btn-neutral border-base mx-1" data-toggle="popover" title="Process Passenger's Complain" data-content="This is a popover content.">
