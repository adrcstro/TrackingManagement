...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // First row
    $pdf->Cell(0, 10, 'Table Header 1', 1, 0, 'C', 1); // First column with color
    $pdf->Cell(0, 10, 'Table Header 2', 1, 1, 'C', 1); // Second column with color

    // Second row
    $pdf->Cell(0, 10, 'Table Data 1', 1, 0, 'C'); // First column
    $pdf->Cell(0, 10, 'Table Data 2', 1, 1, 'C'); // Second column
        }
