...
<main>
    ...
    <ul class="dropdown-menu">
        ...
        <li><a class="dropdown-item" value="passenger" href="#" onclick="changeLoginType('Passenger')">Passenger</a></li>
        <li><a class="dropdown-item" value="driver" href="#" onclick="changeLoginType('Driver')">Driver</a></li>
        <li><a class="dropdown-item" value="admin" href="#" onclick="changeLoginType('Admin')">Admin</a></li>
    </ul>
</div>
