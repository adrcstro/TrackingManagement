...
if (isset($_GET['username'])) {
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo '<img src="uploads/' . htmlspecialchars($row["PermittoOperate"]) . '" class="img-fluid mb-3 mt-10">';
            echo "</div>";
            echo '<div class="col-md-6">';
            ...
            echo "<div class='image-box border rounded p-3' style='display: inline-block; position: relative;'>";
            
            // Add a cover with a background color (you can change the color code)
            echo "<div class='image-cover' style='position: absolute; top: 0; left: 0; width: 100%; height: 100%; background-color: rgba(0, 0, 0, 0.5);'></div>";
            
            echo '<img src="uploads/' . htmlspecialchars($row["Profile"]) . '" class="img-fluid mb-5 mt-2" style="width: 100px; height: 100px;">'; // Adjust the width and height as needed
            ...
            echo "</div>";
            echo "<div class='col-md-6 mb-3'>";
            echo "<label for='age'>Tricycle Unit#</label>";
