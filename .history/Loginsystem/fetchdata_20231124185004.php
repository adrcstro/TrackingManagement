...
<div class="container">
        <div class="row">
            <div class="col-md-6">
                <h1 class="text-center mt-4">Rating Search and Graph</h1>

                <form method="post" action="" class="mt-2">
                    <label for="search">Search by Driver Name:</label>
                    <div class="input-group mt-2">
                        <input type="text" name="search" id="search" class="form-control">
                        <button type="submit" class="btn btn-primary"><i class="bi bi-search icon"></i>Search</button>
                    </div>
                </form>

                <!-- Input field for max value of the left axis -->
                <label for="maxLeft" class="mt-2">Max for Left Axis:</label>
                <div class="input-group mt-2">
                    <input type="number" name="maxLeft" id="maxLeft" value="5" class="form-control">
                    <button onclick="updateChart()" class="btn btn-success"><i class="bi bi-bar-chart icon"></i>Update Chart</button>
                </div>
            </div>
        </div>
    </div>
