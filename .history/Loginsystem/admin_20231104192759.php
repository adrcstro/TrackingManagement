        ...
        <main class="py-6 bg-surface-secondary">
            <div class="container-fluid">
                ...
                <div  id="Admin-table" class="card shadow border-0 mb-7">
                    ...
                    <div class="card-footer border-0 py-7 d-flex justify-content-center flex-wrap">
    <button type="button" class="btn btn-primary btn-sm m-1">Create</button>
    <button type="button" class="btn btn-primary btn-sm m-1">Update</button>
</div>
