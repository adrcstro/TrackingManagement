...
<button type="button" class="btn btn-secondary btn-sm m-1" data-toggle="modal" data-target="#open-modal-button">
...
<div id="modal-container-Rate">
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function () {
      ...
      const modalContainer = document.getElementById('modal-container-Rate');
