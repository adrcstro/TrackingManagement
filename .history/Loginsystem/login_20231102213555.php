...
<main>
    ...
    <option value="passenger" onclick="changeLoginType('Passenger')">Passenger</option>
    <option value="driver" onclick="changeLoginType('Driver')">Driver</option>
    <option value="admin" onclick="changeLoginType('Admin')">Admin</option>
</select><br><br>
