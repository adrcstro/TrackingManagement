...
<script>
    ...
    <div class="form-group">
    <label  for="TypeofComplaints">Type of Complaint</label>
    <select name="TypeofComplaints" id="TypeofComplaints" class="form-control" required>
...
<script>
  $(document).ready(function() {
    $("#CompplainUpdate").click(function() {
      ...
      var TypeofComplaints = $("input[name='TypeofComplaints']").val();
