        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form method="POST" class="text-center mt-3" id="addressForm" style="margin-top: 40px;">
                        ...
                        <div class="form-group row justify-content-center">
                            <div class="col-sm-10">
                            <button type="button" class="btn btn-primary" onclick="updateMap()" style="margin-top: 10px;">
    Submit <i class="fas fa-check"></i>
</button>

<button type="button" class="btn btn-secondary ml-2" name="paste_address" style="margin-top: 10px;">
