...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($selectedDriver)) {
        ...
        $stmtDriver->bind_param("ssssssss", $driverAge, $driverPlanteNumber, $driversDriversLicense, $driverVehicleRegistration, $driversPermittoOperate, $driversPhoneNumber, $driversHomeAddress, $selectedDriver);
