...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $PassegerName = $_POST["SelectPassenger"];
    ...
    if (!empty($PassengerName)) {
        $sql = "UPDATE passengertbl SET Name='$PassengerName', Age='$PassengerAge', Gender='$PassengerGender', Phone='$PassengerPhone', HomeAddress='$PassengerAddress' , Username='$PassengerEmail'WHERE Name='$PassengerName'";
...
<script>
  $(document).ready(function() {
    $("#PassengerRegister").click(function() {
      var  PassengerName = $("input[name=' PassengerName']").val();
