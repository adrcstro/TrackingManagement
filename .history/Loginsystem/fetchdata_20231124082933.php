...
<div style="padding: 20px;">
    <form action="" method="get">
        <label for="driverName">Search Driver:</label>
...
if (isset($_GET['driverName'])) {
    ...
    // Fetch data from the database based on the driverName
    $sql = "SELECT * FROM rating WHERE DriverName = '$driverName'";
    ...
    if ($result->num_rows > 0) {
        ...
        echo "No data found for the specified driver.";
    }
}
