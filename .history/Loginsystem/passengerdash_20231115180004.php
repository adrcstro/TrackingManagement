...
<div class="form-group g-col-6 g-col-md-4">
    ...
    <div class="form-group g-col-6 g-col-md-4">
    <label for="PassSearchDriver">Search Name of Complainee or Any of these VehicleNumber/PlateNumber</label>
    <input type="text" name="PassSearchDriver" id="PassSearchDriver" class="form-control" placeholder="Name/VehicleNumber/PlateNumber" required>
    </div>
</form>
...
<div class="modal-footer">
    ...
    <button id="filereportRegister" type="button" class="btn btn-danger">
