...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        if ($row["ComplainStatus"] === "Scheduled") {
            echo '<div class="card">
                    <div class="card-header">' . $row["TypeofComplaint"] . '</div>
                    <div class="card-body">
                        <h5 class="card-title">Complain ID: ' . $row["ComplaintID"] . '</h5>
                        <p class="card-text">
                            <strong>Date of Report:</strong> ' . $row["DateofReport"] . '<br>
                            <strong>Complainant Name:</strong> ' . $row["ComplainantName"] . '<br>
                            <strong>Contact Number:</strong> ' . $row["ContactNumber"] . '<br>
                            <strong>Address:</strong> ' . $row["Address"] . '<br>
                            <strong>Proof of Identity:</strong> ' . $row["ProfofIdentity"] . '<br>
                            <strong>Incident Description:</strong> ' . $row["IncidentDescription"] . '<br>
                            <strong>Name of Complainee:</strong> ' . $row["NameofComplainee"] . '<br>
                            <strong>Complain Status:</strong> ' . $row["ComplainStatus"] . '<br>
                            <strong>Hearing Date:</strong> ' . $row["hearingdate"] . '<br>
                            <strong>Hearing Time:</strong> ' . $row["hearingtime"] . '<br>
                            <strong>Hearing Place:</strong> ' . $row["hearingplace"] . '<br>
                        </p>
                    </div>
                </div>';
        }
...
?>
                    ...
                    <i class="bi bi-file-earmark-plus"></i> Reschedule Hearing
</button>
                    <button type="button" class="btn btn-primary btn-sm m-1" data-toggle="modal" data-target="#ComplainUpdate">
    <i class="bi bi-arrow-up"></i> Modify
</button>
