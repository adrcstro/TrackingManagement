        ...
        <div class="card-body">
            ...
            <div class="mb-3">
                <div class="icon icon-shape bg-transparent text-primary text-center">
                    ...
                    <img src="../Images/Confirmed.svg" alt="Confirm" class="img-fluid" style="max-width: 300px; height: auto;">
                </div>
            </div>
            <div class="text-sm">
...
<div class="col-xl-3 col-sm-6 col-12">
    <div class="card shadow border-2 text-center">
        <div class="card-body">
            ...
            <div class="mb-3">
                <div class="icon icon-shape bg-transparent text-primary text-center">
                    <img src="../Images/cancel.svg" alt="Cancel" class="img-fluid" style="max-width: 150px; height: auto;">
                </div>
            </div>
            <div class="text-sm">
