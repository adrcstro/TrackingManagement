...
if ($result->num_rows > 0) {
  ...
  if ($usertype == 'admin') {
      $_SESSION['message'] = "Login Successful. Redirecting to admin dashboard.";
      header("Location: admin.php"); // Redirect to the admin dashboard page
      exit();
  } elseif ($usertype == 'driver') {
      $_SESSION['message'] = "Login Successful. Redirecting to driver dashboard.";
      header("Location: driverdash.php"); // Redirect to the driver dashboard page
      exit();
  } elseif ($usertype == 'passenger') {
      $_SESSION['message'] = "Login Successful. Redirecting to passenger dashboard.";
...
if (isset($_SESSION['message'])) {
    ...
    echo "<script>swal({title: '$message', icon: 'success'}).then(() => { window.location.href = 'desired_page.php'; });</script>";
}
?>
<main>
      <div class="box">
