    ...
    <div class="card shadow border-2">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-auto">
                    <div class="icon icon-shape bg-transparent text-primary text-center">
                        <!-- Replace the existing icon with the SVG image -->
                        <img src="../Images/Confirmed.svg" alt="Confirm" class="img-fluid" style="max-width: 100px; height: auto; display: block; margin: 0 auto;">
                    </div>
                </div>
            </div>
            <div class="mt-2 mb-0 text-sm text-center">
                <button type="button" class="btn d-inline-flex btn-sm btn-neutral border-base mx-1" title="Process Passenger's Complaint about the tricycle service, the local transportation authority " onclick="updateRating('Confirm')">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-auto">
                    ...
                    <img src="../Images/cencel.svg" alt="Confirm" class="img-fluid" style="max-width: 100px; height: auto; display: block; margin: 0 auto;">
                    </div>
                </div>
            </div>
            <div class="mt-2 mb-0 text-sm text-center">
            <button type="button" class="btn d-inline-flex btn-sm btn-neutral border-base mx-1" title="Process Passenger's Complaint about the tricycle service, the local transportation authority " onclick="updateRating('Cancel Appointment')">
    <i class="bi bi-arrow-up me-1"></i>Select
</button>
