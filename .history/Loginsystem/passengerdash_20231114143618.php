...
<div class="form-group g-col-6 g-col-md-4">
    ...
    <div class="form-group g-col-6 g-col-md-4">
        <label id="Fileinput5" for="Fileinput5">Try to Identify Toda Drivers By these </label>
        <input name="Fileinput5" type="text" class="form-control" value="Name/VehicleNumber/PlateNumber" required>
    </div>
</form>
</div>
