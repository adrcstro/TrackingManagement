...
<main>
    ...
    <button class="btn dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false" id="loginDropdown">
        Login as 
    <select name="usertype" id="usertype" class="dropdown-menu">
        <li value="passenger"> <option value="admin">Admin</option></li>
        <li value="driver"> <option value="driver">Driver</option></li>
        <li value="admin"> <option value="passenger">Passenger</option></li>
</select>
</div>
