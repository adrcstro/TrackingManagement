    ...
    <?php
        ...
        if ($result) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<div class="cards h-100 border rounded shadow-sm">';
                ...
                echo '<p class="card-text">' . $trimmed_body . ' <a href="#" class="read-more btn btn-primary btn-sm" data-toggle="modal" data-target="#readMoreModal' . $row['NewsID'] . '">Read More</a></p>';
                echo '</div>';
                echo '</div>';
                echo '</div>';
