        ...
        <div class="inner-box">
          <div class="forms-wrap">
            <form id="clear"  action="<?php echo $_SERVER['PHP_SELF']; ?>" autocomplete="off" method="post" class="sign-in-form"   >
              ...
              <div class="dropdown" name="usertype" id="usertype">
              <button class="btn dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false" id="loginDropdown">
        Login as
    </button>
    <select class="dropdown-menu" name="usertype" id="usertype">
      <option><li><a class="dropdown-item" href="#" onclick="changeLoginType('Passenger')">Passenger</a></li></option>
        <option> <li><a class="dropdown-item" href="#" onclick="changeLoginType('Driver')">Driver</a></li></option>
        <option><li><a class="dropdown-item" href="#" onclick="changeLoginType('Admin')">Admin</a></li></option>
    </select>
</div>
