...
<div class="formsignin">
  ...
  <input class="form-control" type="file" id="Driver's-License" title="Please ensure the image is clear and legible" class="custom-title">
</div>

<div id="Filefield" class="input-wrap">
  <label for="formFile" class="custom-label">Vehicle Registration</label>
  <input class="form-control" type="file" id="Vehicle-Registration" title="Please ensure the image is clear and legible" class="custom-title">
</div>
<div id="Filefield" class="input-wrap">
  <label for="formFile" class="custom-label">Permit to Operate</label>
  <input class="form-control" type="file" id="Permit-to-Operate" title="Please ensure the image is clear and legible" class="custom-title">
</div>
