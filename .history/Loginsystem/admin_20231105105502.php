...
?>
<button type="button" class="btn btn-warning btn-sm m-1" data-toggle="modal" data-target="#update" id="updateButton">
    <i class="bi bi-pencil"></i> Update
</button>
...
<script>
    $(document).ready(function(){
        $("#updateButton").click(function(){
            var updatedUsername = $("#input2").val();
            var updatedDate = $("#datePicker").val();
            var updatedPassword = $("#input3").val();
            var selectedAdmin = $("#input1").val();

            $.post("admin.php",
            {
                input1: selectedAdmin,
                input2: updatedUsername,
                datePicker: updatedDate,
                input3: updatedPassword
            },
            function(data, status){
                alert("Data: " + data + "\nStatus: " + status);
                location.reload(); // Reload the page after the update is complete
            });
        });
    });
</script>
