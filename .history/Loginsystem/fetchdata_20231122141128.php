...
echo '<h6 class="card-title">Drivers Vehicle Number: <span style="font-weight:normal;">' . $ViehicleNumber . '</span></h6>';
echo '<h6 class="card-title">Drivers Plate Number: <span style="font-weight:normal;">' . $PlateNumber . '</span></h6>';
