...
<div class="col-xl-3 col-sm-6 col-12">
    <div class="card shadow border-2">
        <div class="card-body">
            ...
            <button type="button" class="btn d-inline-flex btn-sm btn-neutral border-base mx-1" title="Process Passenger's Complaint" data-content="Process Passenger Complaint by selecting this status and take necessary actions.">
...
<div class="col-xl-3 col-sm-6 col-12">
    <div class="card shadow border-2">
        <div class="card-body">
            ...
            <div class="mt-2 mb-0 text-sm text-center">
            <button type="button" class="btn d-inline-flex btn-sm btn-neutral border-base mx-1" title="Process">
    <i class="bi bi-arrow-up me-1"></i>Select
</button>
            </div>
        </div>
...
<div class="col-xl-3 col-sm-6 col-12">
    <div class="card shadow border-2">
        <div class="card-body">
            <div class="row">
                <div class="col">
                    <span class="h6 font-semibold text-muted text-sm d-block mb-2">Dismiss</span>
                </div>
                <div class="col-auto">
                    <div class="icon icon-shape bg-transparent text-primary text-lg">
