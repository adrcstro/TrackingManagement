...
<div class="form-group g-col-6 g-col-md-4">
    ...
    <div class="form-group g-col-6 g-col-md-4">
        ...
        <input name="Fileinput6" type="file" class="form-control" accept=".jpg, .png .jpeg .pdf, .doc, .docx" required>
    </div>
...
$(document).ready(function () {
    $('#filereportRegister').click(function (e) {
        ...
        var formData = new FormData();
        formData.append('Fileinput1', $('#Fileinput1')[0].files[0]);
        formData.append('datefilereport', $('#datefilereport').val());
        formData.append('Fileinput3', $('#Fileinput3')[0].files[0]);
        formData.append('Fileinput4', $('#Fileinput4')[0].files[0]);
        formData.append('Fileinput5', $('#Fileinput5')[0].files[0]);
