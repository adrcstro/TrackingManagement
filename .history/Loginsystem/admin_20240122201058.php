...
<div class="col-xl-3 col-sm-6 col-12">
    <div class="card shadow border-2">
        <div class="card-body">
            ...
            <div class="mt-2 mb-0 text-sm text-center">
                <button type="button" class="btn d-inline-flex btn-sm btn-neutral border-base mx-1" title="The barangay officials diligently coordinated the schedules of the two parties involved, ensuring a mutually convenient time for them to meet and discuss the  issue." onclick="toggleInputFields()">
                    <i class="bi bi-arrow-up me-1"></i>Select
                </button>
            </div>
...
<div class="row hidden" id="inputFields">
                ...
                <div class="col-md-6">
                    <div class="form-group g-col-6">
                        <label for="Fileinput5">Select Time</label>
                        <input id="Fileinput5" name="Fileinput5" type="time" class="form-control" required>
                    </div>
                </div>
            </div>
