...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_FILES['DriversDriversLicense']) && isset($_FILES['DriverVehicleRegistration']) && isset($_FILES['DriversPermittoOperate'])) {
        ...
        // Your file handling code here, such as moving uploaded files to a specific directory
        // Example: move_uploaded_file($_FILES['DriversDriversLicense']['tmp_name'], $target_directory);
    } else {
        // Handle the case when files are not uploaded
    }
