...
if (isset($_GET['search'])) {
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo '<p><img src="data:image/jpeg;base64,'.base64_encode($row["PermittoOperate"]).'" style="max-width: 300px; max-height: 300px; border: 1px solid #ccc; border-radius: 5px;" alt="Permit to Operate"></p>';
        }
    } else {
