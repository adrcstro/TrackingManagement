...
echo '<input type="text" value="Drivers License: ' . $row["DriversLicense"] . '" readonly style="border: 1px solid #ccc; padding: 5px; margin-bottom: 10px; border-radius: 5px; width: 250px;">';
echo '<i class="bi bi-eye" style="margin-left: -25px; position: absolute; top: 50%; transform: translateY(-50%); cursor: pointer; font-size: 1.2rem;"></i>';
echo '</p>';
echo '<p style="position: relative;">';
echo '<input type="text" value="Vehicle Registration: ' . $row["VehicleRegistration"] . '" readonly style="border: 1px solid #ccc; padding: 5px; margin-bottom: 10px; border-radius: 5px; width: 250px;">';
echo '<i class="bi bi-eye" style="margin-left: -25px; position: absolute; top: 50%; transform: translateY(-50%); cursor: pointer; font-size: 1.2rem;"></i>';
echo '</p>';
echo '</div>';
