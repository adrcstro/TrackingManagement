...
echo '<p><input type="text-area" value="Incident Description: ' . $row["NameofComplainee"] . '" readonly style="border: 1px solid #ccc; padding: 5px; margin-bottom: 10px; border-radius: 5px; width: 300px;"></p>';
