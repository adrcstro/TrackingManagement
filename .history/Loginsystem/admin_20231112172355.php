...
document.getElementById('copyButton').addEventListener('click', function() {
    ...
    homeAddressInput.select();
    homeAddressInput.setSelectionRange(0, 99999); // For mobile devices

    // Copy the selected text to the clipboard
    document.execCommand('copy');

    // Deselect the text
    homeAddressInput.setSelectionRange(0, 0);

    // Optionally, you can provide some feedback to the user (e.g., show a tooltip)
    // You can add your own code here to notify the user that the text has been copied
    // For example, you can use a library like Bootstrap's Popover or create your own notification.
});
</script>
