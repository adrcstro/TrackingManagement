    ...
    <?php
      ...
      if ($result) {
          ...
          while ($row = mysqli_fetch_assoc($result)) {
              ...
              echo '<p class="card-text">' . $trimmed_body . '</p>';
              echo '</div>';
              echo '<div class="card-footer text-center bg-transparent d-flex justify-content-center align-items-center">';
              echo '<a href="#" class="read-more-btn btn btn-primary" data-toggle="modal" data-target="#readMoreModal' . $row['NewsID'] . '">Read More <i class="bi bi-arrow-right-square"></i></a>';
              echo '</div>';
              echo '</div>';
              echo '</div>';
