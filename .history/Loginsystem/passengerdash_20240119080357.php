...
<script>
        ...
        <div class="modal-dialog" id="lostandfound"  >
            <div class="modal-content">
                ...
                <!-- Modal Body -->
                <div class="modal-body">
                <form id="postItemForm" action="passengerdash.php" method="post" enctype="multipart/form-data">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
    ...
    $(function(){
        $('#SaveItem').click(function(e){
            ...
            if(valid){
                ...
                $.ajax({
                    type: 'POST',
                    url: 'passengerdash.php', // Change the URL to passengerdash.php
                    data: formData,
                    processData: false,
                    contentType: false,
                    success: function(data) {
                        // Check if the response from passengerdash.php indicates success
                        if (data.indexOf("Item Posted successfully") !== -1) {
                            // Display SweetAlert within the modal
                            swal({
                                title: "Success",
                                text: data,
                                icon: "success",
                                ...
                                if (value) {
                                    // Reset the form
                                    $('#postItemForm')[0].reset();
                                    // Close the modal
                                    $('#postitemmodal').modal('hide');
                                }
                            });
                        } else {
                            // Handle other cases where the response is not a success message
