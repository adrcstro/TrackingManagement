...
echo '<span class="input-group-text"><i class="fas fa-id-card"></i> Drivers License</span>';
echo '</div>';
...
echo '<div class="input-group mb-3">';
echo '<div class="input-group-prepend">';
echo '<span class="input-group-text"><i class="fas fa-car"></i> Vehicle Registration: ' . $row["VehicleRegistration"] . '</span>';
echo '</div>';
