        ...
        <div class="inner-box">
          <div class="forms-wrap">
            <form id="clear"  action="<?php echo $_SERVER['PHP_SELF']; ?>" autocomplete="off" method="post" class="sign-in-form"   >
              ...
              <div class="dropdown">
    <button class="btn dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false" id="usertypeDropdown">
        Login as
    </button>
    <ul class="dropdown-menu">
        <li><a class="dropdown-item" href="#" onclick="changeLoginType('admin')" name="usertype" id="usertype_admin">Admin</a></li>
        <li><a class="dropdown-item" href="#" onclick="changeLoginType('driver')" name="usertype" id="usertype_driver">Driver</a></li>
        <li><a class="dropdown-item" href="#" onclick="changeLoginType('passenger')" name="usertype" id="usertype_passenger">Passenger</a></li>
    </ul>
</div>
<script>
