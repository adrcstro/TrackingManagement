...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($selectedDriver)) {
        ...
        $stmtDriver->bind_param("ssssssss", $driverAge, $driversPlanteNumber, $driversDriversLicense, $driversVehicleRegistration, $driversPermittoOperate, $driversPhoneNumber, $driversHomeAddress, $selectedDriver);
