...
$driverInfoResult = $conn->query($driverInfoQuery);
    ...
    if ($driverInfoResult->num_rows > 0) {
        ...
        $pdf->Cell(90, 30, "PhoneNumber: " . $driverInfo['PhoneNumber'], 1, 1, 'L');
       // Assuming you have already created a table and set its columns

// Move the X-coordinate to the position after the table column


    // Add the cell with the driver's home address
    $pdf->Cell(100, 10, "Address: " . $driverInfo['HomeAddress'], 1, 1, 'L');
