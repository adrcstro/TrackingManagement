...
<div class="custom-tooltip" style="display: none;">
    <strong>Process Passenger's Complaint</strong>
    <p>Process Passenger Complaint by selecting this status and take necessary actions.</p>
</div>
...
<script>
    $(function () {
        // Show custom tooltip on button hover
        $('.btn').hover(
            function () {
                $('.custom-tooltip').show();
            },
...
</script>he same modification for other two sections -->
