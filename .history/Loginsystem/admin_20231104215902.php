...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $brgyAdmin = mysqli_real_escape_string($conn, $brgyAdmin);
    $username = mysqli_real_escape_string($conn, $username);
    $date = mysqli_real_escape_string($conn, $date);
    $password = mysqli_real_escape_string($conn, $password);

    $sql = "INSERT INTO admintbl (BRGY-Admin, Username, Password, DateCreated) 
            VALUES ('$brgyAdmin', '$username', '$date', '$password')";
  ...
  <div class="modal" id="myModal">
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        saveButton.addEventListener('click', function () {
            ...
            var data = "input1=" + input1 + "&input2=" + input2 + "&datePicker=" + datePicker + "&input3=" + input3;
            xhr.send(data);
        });
    });
</script>
