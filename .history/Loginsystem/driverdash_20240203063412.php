...
<div class="modal fade" id="drivercomplainreport">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
            <form id="complaintform" action="generatedriver.php" method="post" enctype="multipart/form-data">


            <label for="SearchReport">Select Report</label>
                        <select name="SearchReport" id="SearchReport" class="form-control" required>
                            <option value="" disabled selected>Select an option</option>
                            <?php
// Replace with your actual database credentials
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        const searchSelect = document.getElementById("SearchReport"); // Change variable name to reflect the select element
        const searchResults = document.getElementById("Complainresult");

        searchSelect.addEventListener("change", function() { // Change event to "change" for select elements
            const selectedOption = searchSelect.value.toLowerCase();
            if (selectedOption !== "") { // Check if an option is selected
                fetch(`Complaindetails.php?search=${selectedOption}`)
