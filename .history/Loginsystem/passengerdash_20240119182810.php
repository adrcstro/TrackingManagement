...
if ($loggedInUserID !== null && $loggedInUsername !== null) {
    ...
    $query = "SELECT Name, Age, Gender, Phone, HomeAddress, Username FROM passengertbl WHERE Id = '$loggedInUserID'";
...
echo "</div>";
echo "<div class='mb-3'>";
echo "<input type='text' id='customerID' value=CostumerID:$loggedInUserID class='form-control' readonly>";
echo "</div>";
echo "<div class='mb-3'>";
...
echo "</div>";
echo "<div class='mb-3'>";
echo "<input type='text' id='homeAddress' value=HomeAddress:{$userData['Username']} class='form-control' readonly>";
echo "</div>";
echo "</form>";
echo "</div>";
echo "</div>";
