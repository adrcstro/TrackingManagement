...
?>
           ...
           <div class="card-footer border-0 py-3 d-flex justify-content-center flex-wrap">
    <div class="col mb-2">
        <button type="button" class="btn btn-warning btn-sm w-100" data-toggle="modal" data-target="#Passengerupdate">
            <i class="bi bi-pencil"></i> Update
        </button>
    </div>

    <div class="col mb-2">
        <button type="button" class="btn btn-danger btn-sm w-100" data-toggle="modal" data-target="#passengerdelete">
            <i class="bi bi-trash"></i> Delete Account
        </button>
    </div>

    <div class="col mb-2">
        <button type="button" class="btn btn-info btn-sm w-100" id="refreshButton2">
            <i class="bi bi-arrow-clockwise"></i> Refresh
        </button>
    </div>
