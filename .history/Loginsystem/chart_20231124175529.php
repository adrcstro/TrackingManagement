...
$(document).ready(function () {
    $('#search').submit(function (e) {
        ...
        fetchDataAndUpdateChart(formData); // Call the function to fetch data and update the chart
    });
});
...
function fetchDataAndUpdateChart(formData) {
    $.ajax({
        type: 'POST',
        url: '', // Leave this empty since the PHP script is in the same file
        data: formData,
...
function updateChartWithData(data) {
    // Your existing code for processing data and updating the chart
    // ...
}
