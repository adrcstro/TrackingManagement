...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if ($role == "Admin") {
    $sql = "SELECT * FROM admintbl WHERE Username='$email' AND Password='$password'";
  } elseif ($role == "Driver") {
    $sql = "SELECT * FROM driverstbl WHERE Name='$email' AND PlateNumber='$password'";
  } elseif ($role == "Passenger") {
    $sql = "SELECT * FROM passengertbl WHERE Email='$email' AND Password='$password'";
  }
