...
<div class="modal fade" id="ratingsModal" tabindex="-1" role="dialog" aria-labelledby="ratingsModalLabel" aria-hidden="true">
    ...
    <script>
    // Replace the value of the "Good" category with the fetched value
    var jsonData = JSON.parse(document.querySelector('[data-stepped-bar]').dataset.steppedBar);
    jsonData.categories[3].value = <?php echo $rateValue; ?>;
    document.querySelector('[data-stepped-bar]').dataset.steppedBar = JSON.stringify(jsonData);
</script>
