...
$pdf->Cell(90, 10, "Plate Number: " . $driverInfo['Password'], 1, 0, 'C');
$pdf->Cell(90, 10, "PhoneNumber: " . $driverInfo['PhoneNumber'], 1, 0, 'C');
...
$pdf->Cell(90, $newCellHeight, "New Information: ", 1, 0, 'C'); // This will NOT start a new line after this cell
