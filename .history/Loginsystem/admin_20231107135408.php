...
<script>
    ...
    <div class="form-group">
        ...
        <input type="file" name="DriversDriversLicense" class="form-control" required>
    </div>
    <div class="form-group">
        <label id="DriverVehicleRegistration" for="DriverVehicleRegistrations">Vehicle Registration</label>
        <input type="file" name="DriverVehicleRegistration" class="form-control" required>
    </div>
    <div class="form-group">
        <label id="DriversPermittoOperate" for="DriversPermittoOperate">Permit to Operate</label>
        <input type="file" name="DriversPermittoOperate" class="form-control" required>
    </div>
    <div class="form-group">
