...
<main>
    ...
    <ul class="dropdown-menu">
        <li><a class="dropdown-item" href="#" name="usertype" id="usertype" onclick="changeLoginType('Passenger')">Passenger</a></li>
        <li><a class="dropdown-item" href="#" name="usertype" id="usertype" onclick="changeLoginType('Driver')">Driver</a></li>
        <li><a class="dropdown-item" href="#" name="usertype" id="usertype" onclick="changeLoginType('Admin')">Admin</a></li>
    </ul>
</div>
<script>
