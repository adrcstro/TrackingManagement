...
echo '<input type="text" class="form-control col-3" placeholder="Recipient\'s username" aria-label="Recipient\'s username" aria-describedby="basic-addon2" value="' . $row["DriversLicense"] . '" readonly>';
...
echo '<div class="input-group mb-3 col-md-6">';
echo '<input type="text" class="form-control col-3" placeholder="Recipient\'s username" aria-label="Recipient\'s username" aria-describedby="basic-addon2" value="' . $row["VehicleRegistration"] . '" readonly>';
echo '<div class="input-group-append">';
echo '<button class="btn btn-outline-secondary" type="button">Button</button>';
echo '</div>';
echo '</div>';
