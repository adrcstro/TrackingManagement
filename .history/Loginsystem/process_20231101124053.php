...
if(isset($_POST['Name'], $_POST['Age'], $_POST['PlateNumber'], $_POST['DriversLicense'], $_POST['VehicleRegistration'], $_POST['PermittoOperate'], $_POST['PhoneNumber'], $_POST['HomeAddress'])){
    $Name                  = $_POST['Name'];
    $Age                   = $_POST['Age'];
    $PlateNumber           = $_POST['PlateNumber'];
    $DriversLicense        = sha1($_POST['DriversLicense']);
    $VehicleRegistration   = sha1($_POST['VehicleRegistration']);
    $PermittoOperate       = sha1($_POST['PermittoOperate']);
