...
if (isset($_GET['username'])) {
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            // Add Image button and Image container
            echo "<div class='col-md-12 mb-3'>";
            echo "<label for='image'>Add Image:</label>";
            echo "<div class='input-group'>";
            echo "<input type='file' id='image' class='form-control' readonly>";
            echo "<div class='input-group-append'>";
            echo "<button class='btn btn-outline-secondary' type='button' onclick='uploadImage()'>Add Image</button>";
            echo "</div>";
            echo "</div>";
            echo "<div id='imageContainer'></div>"; // Image container placeholder
            echo "</div>";
            ...
            echo "  // Implement your image upload logic here";
            echo "}";
            echo "</script>";
