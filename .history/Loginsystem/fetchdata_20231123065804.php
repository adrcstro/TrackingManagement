    ...
    <?php
        ...
        if ($result) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<button class="btn btn-primary rounded-pill mt-3 mr-3"><i class="fas fa-star"></i> Ratings</button>';

                // Comments button with icon
                echo '<button class="btn btn-secondary rounded-pill mt-3"><i class="fas fa-comments"></i> Comments</button>';
