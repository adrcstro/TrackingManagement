...
if (isset($_GET['username'])) {
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo '<img src="uploads/' . htmlspecialchars($row["Profile"]) . '" class="img-fluid mb-5 mt-2" style="width: 150px; height: 150px;">'; // Adjust the width and height as needed
            echo "</div>";
            echo "</div>";
            echo "</div>";
            ...
            echo "<label for='fileInput' class='btn btn-success' style='height: 20px; width: 100px; display: flex; align-items: center; justify-content: center;'>
