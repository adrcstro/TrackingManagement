...
<script>
  ...
  <input  class="form-control" type="file"  name="itemimage" accept=".jpg, .png .jpeg .pdf, .doc, .docx">
    ...
    $('#SaveItem').click(function(e) {
        ...
        e.preventDefault();sconsole.log("Document ready!"); // Check if this message appears in the console
    $('#SaveItem').click(function(e) {
        console.log("Button clicked!"); // Check if this message appears in the console
        e.preventDefault();
            ...
            if (valid) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        swal("Success", "Item Posted Successfully", "success").then((value) => {
                            if (value) {
                                // Optionally, you can perform additional actions after success
                                // For example, clear the form or reload some content on the page
