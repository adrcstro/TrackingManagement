...
echo '</button>';
echo '</div>';
echo '<div class="modal-body d-flex flex-wrap flex-column-reverse">'; // Reverse the order on smaller screens
...
echo '</div>';
echo '<div class="modal-image-container" style="flex: 1; min-width: 200px; max-width: 100%; order: 1;">'; // Set max-width to 100%
