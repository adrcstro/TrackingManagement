  ...
  <?php
      ...
      if ($result) {
          ...
          while ($row = mysqli_fetch_assoc($result)) {
           ...
           echo '<div id="homenews" class="modal-dialog modal-lg" role="document">';
           ...
           echo '</button>';
           echo '</div>';
           echo '<div class="modal-body d-flex flex-wrap">'; // Default layout for larger screens
           ...
           echo "<p class='lead'>" . htmlspecialchars($body, ENT_QUOTES) . "</p>";
           echo '</div>';
           echo '<div class="modal-image-container" style="flex: 1; min-width: 200px; max-width: 50%;">';
           echo "<img src='Loginsystem/uploads/" . htmlspecialchars($image, ENT_QUOTES) . "' class='card-img-top img-fluid' alt='Card Image'>";
           echo '</div>';
           echo '</div>';
           echo '</div>';
           echo '</div>';
           ...
           // Media query for screens with a maximum width of 767 pixels (typical for mobile phones and tablets)
           echo '<style>';
           echo '@media (max-width: 767px) {';
           echo '.modal-body {';
           echo '  flex-direction: column-reverse;'; // Reverse the order on smaller screens
           echo '}';
           echo '.modal-image-container {';
           echo '  order: 1;'; // Set the order of the image to 1 (above text)
           echo '  max-width: 100%;'; // Set max-width to 100%
           echo '}';
           echo '}';
           echo '</style>';
...
<!--About Section-->
<div id="abouthomesec"  class="mb-5" > 
...
<img src="Images/abtimage.svg">
  </div>
<div class="about-content">
  <h2 >Plate-to-Place Tricycle Tracking Management in Brangay 409 Sampaloc Manila</h2>
<p style="text-align: justify;">
In Barangay 409, a pioneering Complain and Identity Tracking System (CITS) has been implemented
 to address issues related to tricycle drivers efficiently. This system streamlines the reporting
  process for residents, allowing them to submit complaints regarding tricycle services. With a centralized
   platform, the barangay can track and investigate reported incidents, maintaining a record of individual
    tricycle drivers' behavior and performance. The CITS promotes transparency by providing real-time updates on
     the status of complaints, fostering trust and accountability within the community. Overall, this innovative 
     system demonstrates the barangay's commitment to improving the oversight and management of tricycle services,
...
<div class="container-fluid" id="Services" style="display: none;" >
    <h1 class="text-center mt-5 text-underline">System Service Offers</h1>
    <div class="row mb-5">

        <div class="col-12 col-sm-6 col-md-3 m-auto mb-4 mb-sm-4">
            <!-- card starts here -->
            <div class="card shadow">
                <img src="images/news.svg" alt="" class="card-img-top">
                <div class="card-body">
        ...
        <div class="col-12 col-sm-6 col-md-3 m-auto mb-4 mb-sm-4">
            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    <p class="mb-0">
                        Plate-to-Place Barangay Tricycle Tracking management Offers services that can access the Vehicle Information
                        of Driver by the Authorize personnel for Possible Complain
                    </p>
                </div>
            </div>
            <!-- card ends here -->
        ...
        <div class="col-12 col-sm-6 col-md-3 m-auto mb-4 mb-sm-4">
            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    <p class="mb-0">
                        This system has expanded its capabilities to include a "File a Report for Inconvenience"
            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    <p class="mb-0">
                        ...
                        comprehensive tracking management services to help passengers report any inconvenience services.
                    </p>
                </div>
            </div>
            <!-- card ends here -->
        ...
        <div class="col-12 col-sm-6 col-md-3 m-auto mb-4 mb-sm-4">
            <!-- card starts here -->
            <div class="card shadow">
                <img src="images/lostandfound.svg" alt="" class="card-img-top">
                <div class="card-body">
                    <h3 class="text-center">Lost&Found</h3>
                    <p class="mb-0">
                        Brangay-409 is dedicated to providing a comprehensive Lost and Found service to our community, 
                        ensuring a swift and efficient resolution for those who have misplaced their belongings.
                    </p>
                </div>
            </div>
            <!-- card ends here -->
        ...
        <div class="col-12 col-sm-6 col-md-3 m-auto mb-4 mb-sm-4">
            <!-- card starts here -->
            <div class="card shadow">
                <img src="images/Rate.svg" alt="" class="card-img-top">
                <div class="card-body">
                    <h3 class="text-center">Rate Service</h3>
                    <p class="mb-0">
                    Barangay 409 offers a Professional Rating Services for Tricycle Experience that has a Capability to Rate
                    and submit feed back to rate the performances of Drivers along Barangay-409
                </div>
            </div>
            <!-- card ends here -->
        </div>
        <!-- Repeat the code block above for each card -->
        <div class="col-12 col-sm-6 col-md-3 m-auto mb-4 mb-sm-4">
            <!-- card starts here -->
            <div class="card shadow">
                <img src="images/waste.svg" alt="" class="card-img-top">
                <div class="card-body">
                    <h3 class="text-center">Waste</h3>
                    <p class="mb-0">
                    At Barangay 409, we take pride in our waste management service designed to elevate community well-being.
                     Experience hassle-free waste disposal with our prompt collection, responsible segregation
                    </p>
                </div>
            </div>
            <!-- card ends here -->
        ...
        <div class="col-12 col-sm-6 col-md-3 m-auto mb-4 mb-sm-4">
            <!-- card starts here -->
            <div class="card shadow">
                <img src="images/Fare.svg" alt="" class="card-img-top">
                <div class="card-body">
                    <h3 class="text-center">Fare Calculator</h3>
                    <p class="mb-0">
                    Revolutionize your commuting experience with our Fare Calculator service. Say goodbye to uncertainties and  
                    as we provide real-time fare estimates, ensuring transparent for your tricycle rides,
                    </p>
                </div>
            </div>
            <!-- card ends here -->
...
<section style="display: none; margin-top: 4rem; " class="section p-7 " id="FAQ">
  <div class="container">
    <div class="row">
      <div class="col-md-6">
