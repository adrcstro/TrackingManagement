...
<nav class="navbar navbar-expand-lg navbar-light  bg-white shadow">
    ...
    <h3 class="text"><img src="../images/webicon.png" width="40"><span class="text-info"></span>BRGY-409</h3> <!-- Adjust width and height according to your design -->
    BARANGAY-<span style="color: #603ce6;">409</span>
  </a>
