...
<nav class="navbar navbar-expand-lg navbar-light  bg-white shadow">
    ...
    <h3 class="text"><img src="../images/webicon.png" width="10"><span class="text-info"></span>BRGY-409</h3>
</a>
  ...
  <div class="footer-container">
      <div class="footer-row">
            <div class="col" id="company">
              <a class="logo text-white" <img src="../images/webicon.png"  href="#">BRGY-409 CITY OF MANILA</a>
                <p id="fotlog">
