        ...
        <div class="col-12 col-sm-6 col-md-3 m-auto mb-4 mb-sm-4">
            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    <p class="mb-0">
                    Revolutionize your commuting experience with our Tricycle Fare Calculator service. Say goodbye to uncertainties and hassles 
                    as we provide real-time fare estimates, ensuring transparent and reliable pricing for your tricycle rides,
                    </p>
                </div>
            </div>
            <!-- card ends here -->
