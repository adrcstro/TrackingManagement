  ...
  <?php
      ...
      if ($result) {
          ...
          while ($row = mysqli_fetch_assoc($result)) {
              ...
              echo '<img src="Loginsystem/uploads/' . $image . '" class="card-img-top" alt="Card Image">';
...
<div class="container" id="Services">
    ...
    <div class="row mt-4">
        <div class="col-md-6">
            ...
            <div class="card h-100 shadow d-flex">
                <img src="images/s1.svg" alt="" class="card-img-left">
                <div class="card-body d-flex flex-column justify-content-between">
                    <div>
                        <h3 class="text-center">News/Events</h3>
                        <hr class="mx-auto w-50">
                        <p class="card-text">
                            Tricycle tracking management systems are evolving to offer more comprehensive services by integrating real-time news updates and local event notifications within their platforms.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div class="row mt-4">
        <div class="col-md-6">
            <!-- card starts here -->
            <div class="card h-100 shadow d-flex">
                <img src="images/s2.svg" alt="" class="card-img-left">
                <div class="card-body d-flex flex-column justify-content-between">
                    <div>
                        <h3 class="text-center">Access Data</h3>
                        <hr class="mx-auto w-50">
                        <p class="card-text">
                            Plate-to-Place Barangay Tricycle Tracking management offers services that can access vehicle information of drivers by authorized personnel for possible complaints.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div class="row mt-4">
        <div class="col-md-6">
            <!-- card starts here -->
            <div class="card h-100 shadow d-flex">
                <img src="images/s3.svg" alt="" class="card-img-left">
                <div class="card-body d-flex flex-column justify-content-between">
                    <div>
                        <h3 class="text-center">File Complaint</h3>
                        <hr class="mx-auto w-50">
                        <p class="card-text">
                            This system has expanded its capabilities to include a "File a Report for Inconvenience" allowing commuters to report any inconvenience encountered during their tricycle rides.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div class="row mt-4">
        <div class="col-md-6">
            <!-- card starts here -->
            <div class="card h-100 shadow d-flex">
                <img src="images/s4.svg" alt="" class="card-img-left">
                <div class="card-body d-flex flex-column justify-content-between">
                    <div>
                        <h3 class="text-center">Tracking System</h3>
                        <hr class="mx-auto w-50">
                        <p class="card-text">
                            Plate-to-Place systems have significantly improved their offerings by providing comprehensive tracking management services to help passengers report any inconvenience services.
                        </p>
                    </div>
                </div>
            </div>
