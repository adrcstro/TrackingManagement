...
In Barangay 409, a pioneering Complain and Identity Tracking System (CITS) has been implemented
 to address issues related to tricycle drivers efficiently. This system streamlines the reporting
  ...
  <div class="abtbtn">
    ...
    <a id="abtbtnservice" target="_blank" class="read-more m-2" style="background-color: transparent; border: 1px solid #603ce6; color: #603ce6;" onclick="showservices()">Services</a>
  </div>
</div>
</section>
</div>
