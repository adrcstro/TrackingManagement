    ...
    <h1 class="mr-2"  >BARANGAY-<span style="color: #603ce6;"> 409</span> </h1>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mx-auto">
          ...
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="#Annoucments">Announcements</a>
          </li>
        </ul>
    ...
    <div id="shorcard" class="card shadow">
        ...
        <div class="card-body">
          ...
          <p class="card-text">Lorem ipsum dolor sit, amet consectetur adipisicing elit.
             Beatae ea quasi culpa dolor libero vitae ipsam eaque, 
            sit rem sunt laborum vero ipsum quia cupiditate eum nesciunt ullam sint architecto.</p>
